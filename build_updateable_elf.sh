...
gcc -m32 -Wall -O0 -g -fno-omit-frame-pointer -mtune=nocona -I../lib_tomcrypt/headers -I../lib/mysql/unix -I../lib_tomcrypt/math/tommath -D COD4X18UPDATE -D OFFICIAL -D _GNU_SOURCE -c ../src/*.c
