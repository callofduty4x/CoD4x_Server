...
StuckInClient_80:
	...
	mov eax, [ebx+0x15c]
	movaps xmm0, xmm1
	xorps xmm0, [_ZZ15G_TouchTriggersP9gentity_sE5range+0x20]
	movaps xmm1, xmm0
	mulss xmm1, [ebp-0x20]
	movss [eax+0x28], xmm1
	mulss xmm0, [ebp-0x1c]
...
SpectatorThink_60:
	...
	mov eax, [edi+0x1c]
	mov [ebp-0x108], eax
	mov dword [ebp-0xe4], g_clients+0x9a611
...
P_DamageFeedback_50:
	...
	xorps xmm6, [_ZZ15G_TouchTriggersP9gentity_sE5range+0x10]
...
P_DamageFeedback_60:
	...
	movaps xmm5, xmm6
	xorps xmm5, [_ZZ15G_TouchTriggersP9gentity_sE5range+0x10]
