...
_cstring_testing_drop_err:		db 15h,"Testing drop error",0
_cstring_testing_fatal_er:		db 15h,"Testing fatal error",0
_cstring_configure_mpcsv_:		db 15h,"configure_mp.csv: dvar name ",22h,"%s",22h," longer than %i",0ah,0
_cstring_configure_mpcsv_1:		db 15h,"configure_mp.csv: more than %i dvars",0ah,0
_cstring_configure_mpcsv_2:		db 15h,"configure_mp.csv: unexpected end-of-file",0
_cstring_configure_mpcsv_3:		db 15h,"configure_mp.csv: extra dvar value column(s): value = %s",0ah,0
_cstring_configure_mpcsv_4:		db 15h,"configure_mp.csv: missing entry in dvar value column %i",0ah,0
_cstring_configure_mpcsv_5:		db 15h,"configure_mp.csv: entry ",27h,"%s",27h," in dvar value column %i is longer than %i",0ah,0
...
_cstring_com_eventloop_ba:		db 15h,"Com_EventLoop: bad event type %i",0
_cstring_:		db 0ah,0
...
_cstring_configure_mpcsv_6:		db 15h,"configure_mp.csv: sys mb %i not allowed to be less than 128",0ah,0
_cstring_configure_mpcsv_7:		db 15h,"configure_mp.csv: ",22h,"sys mb",22h," should be the second column",0ah,0
_cstring_configure_mpcsv_8:		db 15h,"configure_mp.csv: ",22h,"cpu ghz",22h," should be the first column",0ah,0
_cstring_configure_mpcsv_9:		db 15h,"configure_mp.csv: ",14h,"EXE_ERR_COULDNT_CONFIGURE",15h," %.0f GHz %i MB",0ah,0
_cstring_configure_mpcsv_10:		db 15h,"configure_mp.csv: ",14h,"EXE_ERR_COULDNT_CONFIGURE",15h," ",22h,"%s",22h,0ah,0
_cstring_exe_err_not_foun:		db "EXE_ERR_NOT_FOUND",15h,"configure_mp.csv",0
_cstring_snd_restart:		db "snd_restart",0ah,0
_cstring_configure_mpcsv_11:		db 15h,"configure_mp.csv: ",22h,"find",22h," string is too long",0ah,0
...
_cstring_configure_mpcsv_13:		db 15h,"configure_mp.csv: cpu ghz %g not allowed to be less than 0",0ah,0
