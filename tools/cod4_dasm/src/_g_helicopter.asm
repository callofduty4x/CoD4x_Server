...
;Exports of g_helicopter:
	global VEH_UpdateClientChopper
	global VEH_CheckForPredictedCrash
...
VEH_UpdateClientChopper:
	...
	pxor xmm1, xmm1
	ucomiss xmm0, xmm1
	jbe VEH_UpdateClientChopper_10
	mov edx, eax
	mov eax, [eax+0x2d0]
	mov [ebp-0x70], eax
	mov [ebp-0x6c], eax
	...
	mov [ebp-0x78], eax
	mov [ebp-0x74], eax
VEH_UpdateClientChopper_470:
	mov edx, 0x1
	lea ebx, [ebp-0x108]
	lea ecx, [ebp-0x1c]
	movss xmm1, dword [_float_127_00000000]
VEH_UpdateClientChopper_20:
	...
	add edx, 0x1
	cmp edx, 0x5
	jnz VEH_UpdateClientChopper_20
	movzx eax, byte [ebp-0x1c]
	test al, al
	jnz VEH_UpdateClientChopper_30
	cmp byte [ebp-0x1b], 0x0
	jnz VEH_UpdateClientChopper_30
	movss xmm4, dword [_ZZ10G_DebugBoxPKfS0_S0_fS0_iiE10iEdgePairs+0x80]
	pxor xmm2, xmm2
VEH_UpdateClientChopper_310:
	...
	mov edx, 0x1
	mov eax, 0x4
VEH_UpdateClientChopper_60:
	movss xmm1, dword [eax+ebp-0x74]
	pxor xmm0, xmm0
	ucomiss xmm1, xmm0
	jp VEH_UpdateClientChopper_40
	jz VEH_UpdateClientChopper_50
VEH_UpdateClientChopper_40:
	movss xmm0, dword [eax+ebp-0x80]
	divss xmm0, xmm1
	movss [eax+ebp-0xfc], xmm0
VEH_UpdateClientChopper_330:
	add edx, 0x1
	add eax, 0x4
	cmp edx, 0x4
	jnz VEH_UpdateClientChopper_60
	...
	movss [ebp-0x1d4], xmm0
	movaps xmm1, xmm0
	xorps xmm1, [_ZZ10G_DebugBoxPKfS0_S0_fS0_iiE10iEdgePairs+0x90]
	movaps xmm0, xmm6
	mulss xmm0, xmm1
	addss xmm0, [esi+0x84]
	movss [ebp-0xa0], xmm0
...
VEH_UpdateClientChopper_80:
	...
	jbe VEH_UpdateClientChopper_70
	...
	movaps xmm6, xmm0
VEH_UpdateClientChopper_340:
	movaps xmm4, xmm5
	addss xmm4, xmm6
	movss xmm2, dword [ebx+ebp-0x80]
	movaps xmm3, xmm2
	xorps xmm3, [_ZZ10G_DebugBoxPKfS0_S0_fS0_iiE10iEdgePairs+0x90]
	movaps xmm0, xmm4
	subss xmm0, xmm2
	pxor xmm1, xmm1
	cmpss xmm1, xmm0, 0x6
	...
	jnz VEH_UpdateClientChopper_80
	mov dword [esp+0xc], 0x3d4ccccd
	mov eax, [ebp-0xf0]
	mov [esp+0x8], eax
	mov eax, [esi+0x8c]
	...
	movss xmm5, dword [_ZZ10G_DebugBoxPKfS0_S0_fS0_iiE10iEdgePairs+0x90]
	xorps xmm5, xmm1
...
VEH_UpdateClientChopper_110:
	lea ecx, [ebx*4]
	lea edx, [ebp-0x70]
	add edx, ecx
	pxor xmm0, xmm0
	ucomiss xmm0, [edx-0x4]
	jae VEH_UpdateClientChopper_90
	lea edx, [ebp-0x7c]
	add edx, ecx
	pxor xmm2, xmm2
	ucomiss xmm2, [edx-0x4]
	jae VEH_UpdateClientChopper_100
VEH_UpdateClientChopper_350:
	add ebx, 0x1
	cmp ebx, 0x3
	jnz VEH_UpdateClientChopper_110
	...
	pxor xmm5, xmm5
	ucomiss xmm3, xmm5
	jbe VEH_UpdateClientChopper_120
	movss xmm2, dword [esi+0x94]
	movaps xmm0, xmm2
	andps xmm0, [_ZZ10G_DebugBoxPKfS0_S0_fS0_iiE10iEdgePairs+0x80]
	ucomiss xmm0, xmm5
	jbe VEH_UpdateClientChopper_130
	divss xmm3, xmm4
	mov eax, vehHelicopterTiltFromFwdAndYaw_VelAtMaxTilt
	mov eax, [eax]
	movss xmm0, dword [eax+0xc]
	ucomiss xmm0, xmm3
	ja VEH_UpdateClientChopper_140
	movaps xmm0, xmm6
VEH_UpdateClientChopper_480:
	xorps xmm2, [_ZZ10G_DebugBoxPKfS0_S0_fS0_iiE10iEdgePairs+0x90]
	mov eax, vehHelicopterMaxYawRate
	mov eax, [eax]
...
VEH_UpdateClientChopper_120:
	...
	mov eax, esi
	xor edx, edx
VEH_UpdateClientChopper_170:
	movss xmm0, dword [eax+0xe0]
	ucomiss xmm0, xmm6
	jbe VEH_UpdateClientChopper_150
	mov dword [eax+0xe0], 0x3f800000
	movss xmm0, dword [eax+0xec]
	pxor xmm5, xmm5
	ucomiss xmm0, xmm5
	jbe VEH_UpdateClientChopper_160
VEH_UpdateClientChopper_360:
	mov dword [eax+0xec], 0x0
VEH_UpdateClientChopper_160:
	add edx, 0x1
	add eax, 0x4
	cmp edx, 0x2
	jnz VEH_UpdateClientChopper_170
	lea eax, [ebp-0x88]
	mov [esp+0x8], eax
	mov [esp+0x4], edi
	mov [esp], ecx
	...
	mulss xmm0, xmm2
	ucomiss xmm0, xmm1
	ja VEH_UpdateClientChopper_180
VEH_UpdateClientChopper_380:
	...
	jz VEH_UpdateClientChopper_190
	mov edx, [ebp+0x8]
	mov edi, [edx+0x164]
	add edi, 0xc0
	ucomiss xmm4, [edi+0x78]
	jnz VEH_UpdateClientChopper_200
	jp VEH_UpdateClientChopper_200
	ucomiss xmm4, [edi+0x7c]
	jz VEH_UpdateClientChopper_210
VEH_UpdateClientChopper_200:
	...
	jp VEH_UpdateClientChopper_220
	jb VEH_UpdateClientChopper_190
VEH_UpdateClientChopper_220:
	movaps xmm0, xmm4
	...
	jbe VEH_UpdateClientChopper_230
	movaps xmm0, xmm4
	xorps xmm0, [_ZZ10G_DebugBoxPKfS0_S0_fS0_iiE10iEdgePairs+0x90]
...
VEH_UpdateClientChopper_190:
	...
	ucomiss xmm0, [eax]
	jnz VEH_UpdateClientChopper_240
	jp VEH_UpdateClientChopper_240
	...
	jz VEH_UpdateClientChopper_250
VEH_UpdateClientChopper_240:
	mov eax, [ebx]
	mov [ebp-0xc4], eax
	mov eax, [edi]
	mov [ebp-0xc0], eax
...
VEH_UpdateClientChopper_460:
	mov edx, [ebp+0x8]
	mov [esp], edx
	call VEH_CheckForPredictedCrash
	mov eax, [ebp-0x1f8]
	add eax, 0x84
	mov [esp+0x8], eax
	lea ecx, [ebp-0x168]
	...
	jle VEH_UpdateClientChopper_270
	mov esi, 0x3d4ccccd
	mov [esp+0xc], esi
	mov ebx, 0x40800000
	mov [esp+0x8], ebx
...
VEH_UpdateClientChopper_30:
	...
	cmovl ecx, edx
	test ecx, ecx
	jnz VEH_UpdateClientChopper_280
	movss xmm1, dword [ebp-0x104]
VEH_UpdateClientChopper_320:
	movss xmm4, dword [_ZZ10G_DebugBoxPKfS0_S0_fS0_iiE10iEdgePairs+0x80]
	movaps xmm0, xmm1
	andps xmm0, xmm4
	...
	mov eax, [eax]
	cmp byte [eax+0xc], 0x0
	jz VEH_UpdateClientChopper_290
	...
	andps xmm0, xmm4
	ucomiss xmm3, xmm0
	ja VEH_UpdateClientChopper_300
	movaps xmm1, xmm0
	subss xmm1, xmm3
	movss xmm0, dword [_float_1_00000000]
	subss xmm0, xmm1
	...
	pxor xmm2, xmm2
	jmp VEH_UpdateClientChopper_310
VEH_UpdateClientChopper_280:
	cvtsi2ss xmm0, ecx
	divss xmm0, xmm1
	movaps xmm1, xmm0
	...
	movaps xmm1, xmm0
	jmp VEH_UpdateClientChopper_320
VEH_UpdateClientChopper_50:
	mov dword [eax+ebp-0xfc], 0x3f800000
	jmp VEH_UpdateClientChopper_330
VEH_UpdateClientChopper_70:
	...
	jmp VEH_UpdateClientChopper_340
VEH_UpdateClientChopper_90:
	movss xmm0, dword [eax+0xc]
	mulss xmm0, xmm1
	movss [edx-0x4], xmm0
	lea edx, [ebp-0x7c]
	...
	pxor xmm2, xmm2
	ucomiss xmm2, [edx-0x4]
	jb VEH_UpdateClientChopper_350
VEH_UpdateClientChopper_100:
	movss xmm0, dword [edi+0xc]
	mulss xmm0, xmm1
	movss [edx-0x4], xmm0
	jmp VEH_UpdateClientChopper_350
VEH_UpdateClientChopper_150:
	ucomiss xmm7, xmm0
	jbe VEH_UpdateClientChopper_160
	...
	jbe VEH_UpdateClientChopper_160
	jmp VEH_UpdateClientChopper_360
VEH_UpdateClientChopper_290:
	movaps xmm2, xmm0
	jmp VEH_UpdateClientChopper_310
VEH_UpdateClientChopper_180:
	sqrtss xmm0, xmm1
	movaps xmm1, xmm2
	subss xmm1, xmm0
	divss xmm1, xmm2
	...
	mov edx, [eax+0x1e8]
	test edx, edx
	jnz VEH_UpdateClientChopper_370
	mov eax, [ebx+0x4]
	test eax, eax
	jnz VEH_UpdateClientChopper_370
VEH_UpdateClientChopper_440:
	...
	jmp VEH_UpdateClientChopper_380
VEH_UpdateClientChopper_370:
	mov esi, level
	mov eax, [esi+0x1ec]
	cmp eax, [ebx+0x8]
	jle VEH_UpdateClientChopper_390
	cvtsi2ss xmm0, edx
	ucomiss xmm0, [_float_0_05000000]
	jae VEH_UpdateClientChopper_400
	jp VEH_UpdateClientChopper_400
	mov edx, [ebp-0x1e0]
	mov dword [edx+0x1e8], 0x32
VEH_UpdateClientChopper_400:
	mov eax, [ebx+0x4]
	mov [esp+0x4], eax
	mov ecx, [ebp-0x1e0]
	mov eax, [ecx+0x1e8]
	...
	mov esi, ebx
	xor edi, edi
VEH_UpdateClientChopper_420:
	movss xmm0, dword [esi+0xc]
	ucomiss xmm0, [_float_0_00000000]
	jp VEH_UpdateClientChopper_410
	jnz VEH_UpdateClientChopper_410
VEH_UpdateClientChopper_500:
	add edi, 0x1
	add esi, 0x4
	cmp edi, 0x3
	jnz VEH_UpdateClientChopper_420
	lea edx, [ebx+0x18]
	lea eax, [ebx+0x24]
...
VEH_UpdateClientChopper_430:
	...
	add ebx, 0x4
	cmp esi, 0x3
	jnz VEH_UpdateClientChopper_430
	jmp VEH_UpdateClientChopper_440
VEH_UpdateClientChopper_260:
	movss xmm0, dword [_float_0_05000000]
	...
	pxor xmm1, xmm1
	ucomiss xmm0, xmm1
	jb VEH_UpdateClientChopper_450
	movss xmm1, dword [_float_1_00000000]
VEH_UpdateClientChopper_510:
	mulss xmm3, xmm1
	movss [ebp-0xd0], xmm3
	movaps xmm0, xmm1
	mulss xmm0, [ebp-0xcc]
	...
	pxor xmm3, xmm3
	ucomiss xmm2, xmm3
	jbe VEH_UpdateClientChopper_460
	lea eax, [ebp-0xd0]
	mov [esp], eax
	call Scr_AddVector
	lea eax, [ebp-0xc4]
	...
	mov [esp], eax
	call Scr_Notify
	jmp VEH_UpdateClientChopper_460
VEH_UpdateClientChopper_130:
	movss xmm1, dword [ebp-0x84]
	jmp VEH_UpdateClientChopper_120
VEH_UpdateClientChopper_270:
	mov esi, 0x3d4ccccd
	mov [esp+0xc], esi
	mov ebx, 0x40800000
	mov [esp+0x8], ebx
...
VEH_UpdateClientChopper_10:
	...
	movss [ebp-0x78], xmm0
	movss [ebp-0x74], xmm1
	jmp VEH_UpdateClientChopper_470
VEH_UpdateClientChopper_210:
	jp VEH_UpdateClientChopper_200
	ucomiss xmm4, [edi+0x80]
	jp VEH_UpdateClientChopper_200
	jz VEH_UpdateClientChopper_190
	jmp VEH_UpdateClientChopper_200
VEH_UpdateClientChopper_300:
	movaps xmm1, xmm3
	subss xmm1, xmm0
	movss xmm0, dword [_float_1_00000000]
	subss xmm0, xmm1
	...
	pxor xmm2, xmm2
	jmp VEH_UpdateClientChopper_310
VEH_UpdateClientChopper_250:
	jnp VEH_UpdateClientChopper_460
	jmp VEH_UpdateClientChopper_240
VEH_UpdateClientChopper_140:
	divss xmm3, xmm0
	movaps xmm0, xmm3
	jmp VEH_UpdateClientChopper_480
VEH_UpdateClientChopper_390:
	mov eax, [ebp-0x1e0]
	lea edx, [eax+0x200]
	lea eax, [eax+0x20c]
	jmp VEH_UpdateClientChopper_490
VEH_UpdateClientChopper_410:
	movss [esp+0x4], xmm0
	xorps xmm0, [_ZZ10G_DebugBoxPKfS0_S0_fS0_iiE10iEdgePairs+0x90]
	movss [esp], xmm0
	call G_flrand
	fstp dword [ebp+edi*4-0xac]
	jmp VEH_UpdateClientChopper_500
VEH_UpdateClientChopper_450:
	movss xmm1, dword [_float_1_00000000]
	divss xmm1, xmm2
	jmp VEH_UpdateClientChopper_510
	add [eax], al
...
VEH_CheckForPredictedCrash:
	...
	pxor xmm0, xmm0
	ucomiss xmm1, xmm0
	jp VEH_CheckForPredictedCrash_10
	jz VEH_CheckForPredictedCrash_20
VEH_CheckForPredictedCrash_10:
	ucomiss xmm0, [edx+0x78]
	jnz VEH_CheckForPredictedCrash_30
	jp VEH_CheckForPredictedCrash_30
...
VEH_CheckForPredictedCrash_30:
	...
	ja VEH_CheckForPredictedCrash_40
VEH_CheckForPredictedCrash_20:
	add esp, 0x60
	pop ebx
	pop esi
	pop ebp
	ret
VEH_CheckForPredictedCrash_40:
	lea eax, [ebp-0x3c]
	mov [esp], eax
	call Scr_AddVector
	mov [esp], ebx
