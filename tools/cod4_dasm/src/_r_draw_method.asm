...
;Exports of r_draw_method:
	global R_InitDrawMethod
	global R_UpdateDrawMethod
...
R_InitDrawMethod_20:
	...
	add eax, 0x1
	sub edx, 0x1
	jnz R_InitDrawMethod_20
	add ebx, 0x1
	add ecx, 0x7
	cmp ebx, 0xd
	jnz R_InitDrawMethod_30
	pop ebx
	pop ebp
	ret
R_InitDrawMethod_10:
...
R_InitDrawMethod_50:
	...
	add eax, 0x1
	sub edx, 0x1
	jnz R_InitDrawMethod_50
	add ebx, 0x1
	add ecx, 0x7
	cmp ebx, 0xd
	jnz R_InitDrawMethod_60
	pop ebx
	pop ebp
	ret
R_InitDrawMethod_40:
...
R_UpdateDrawMethod:
	...
	mov edx, [eax+0x536c]
	test edx, edx
	jz R_UpdateDrawMethod_10
	mov edi, eax
	xor esi, esi
R_UpdateDrawMethod_30:
	...
	mov ebx, 0xd
R_UpdateDrawMethod_20:
	movzx eax, byte [ecx]
	mov [edx], al
	add ecx, 0x7
	add edx, 0x100
	sub ebx, 0x1
	jnz R_UpdateDrawMethod_20
	add esi, 0x1
	add edi, 0x40
	mov eax, [ebp+0xc]
	cmp esi, [eax+0x536c]
	jb R_UpdateDrawMethod_30
R_UpdateDrawMethod_10:
	pop ebx
	pop esi
	pop edi
	pop ebp
