...
;Exports of r_outdoor:
	...
	global R_GenerateOutdoorImage
	global R_RegisterOutdoorImage
...
R_GenerateOutdoorImage_50:
	...
	xor ebx, ebx
	jmp R_GenerateOutdoorImage_10
R_GenerateOutdoorImage_30:
	mov edx, 0xffffffff
	cmp eax, 0xff
	cmovle edx, eax
	mov eax, [ebp-0x6c]
	...
	add ebx, 0x1
	cmp ebx, 0x200
	jz R_GenerateOutdoorImage_20
R_GenerateOutdoorImage_40:
	movss xmm4, dword [_float_0_50000000]
R_GenerateOutdoorImage_10:
	...
	jns R_GenerateOutdoorImage_30
	xor edx, edx
	mov eax, [ebp-0x6c]
	mov [eax+ebx], dl
	add ebx, 0x1
	cmp ebx, 0x200
	jnz R_GenerateOutdoorImage_40
R_GenerateOutdoorImage_20:
	add eax, 0x200
	mov [ebp-0x6c], eax
	add dword [ebp-0x70], 0x1
	cmp dword [ebp-0x70], 0x200
	jnz R_GenerateOutdoorImage_50
...
R_RegisterOutdoorImage:
	...
	pxor xmm4, xmm4
R_RegisterOutdoorImage_30:
	movss xmm1, dword [eax]
	ucomiss xmm1, xmm2
	jnz R_RegisterOutdoorImage_10
	jp R_RegisterOutdoorImage_10
	movss [eax], xmm4
	movss [eax+0xc], xmm4
	movss xmm1, dword [eax]
R_RegisterOutdoorImage_10:
	movss xmm0, dword [eax+0xc]
	subss xmm0, xmm1
	ucomiss xmm3, xmm0
	ja R_RegisterOutdoorImage_20
R_RegisterOutdoorImage_60:
	add eax, 0x4
	cmp eax, outdoorGlob+0xc
	jnz R_RegisterOutdoorImage_30
	mov ecx, outdoorMapSize
	mov edx, outdoorGlob+0xc
	movss xmm2, dword [outdoorMapSize+0x10]
R_RegisterOutdoorImage_40:
	mov eax, [ecx]
	sub eax, 0x1
	cvtsi2ss xmm1, eax
	...
	jnz R_RegisterOutdoorImage_40
	mov ecx, 0x1
	mov edx, outdoorGlob+0xc
	lea edi, [ebp-0x24]
	lea esi, [ebp-0x30]
R_RegisterOutdoorImage_50:
	...
	pop ebp
	ret
R_RegisterOutdoorImage_20:
	subss xmm1, xmm5
	movss [eax], xmm1
	movss xmm0, dword [eax+0xc]
	addss xmm0, xmm5
	movss [eax+0xc], xmm0
	jmp R_RegisterOutdoorImage_60
	nop
