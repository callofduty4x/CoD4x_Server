...
;Exports of r_warn:
	...
	global R_WarnInitDvars
	global R_WarnOncePerFrame
...
R_WarnOncePerFrame_40:
	add esp, 0x420
	pop ebx
	pop esi
	pop ebp
	ret
R_WarnOncePerFrame_20:
	call Sys_Milliseconds
	mov [_ZZ17R_UpdateFrameRatevE8previous], eax
	jmp R_WarnOncePerFrame_50
R_WarnOncePerFrame_30:
	call Sys_Milliseconds
	mov edx, eax
	sub edx, [_ZZ17R_UpdateFrameRatevE8previous]
	mov [_ZZ17R_UpdateFrameRatevE8previous], eax
	cmp edx, 0x0
	jz R_WarnOncePerFrame_60
	jl R_WarnOncePerFrame_70
	cvtsi2ss xmm1, edx
R_WarnOncePerFrame_80:
	movss xmm0, dword [_float_1000_00000000]
	divss xmm0, xmm1
	movss [_ZZ17R_UpdateFrameRatevE9frameRate], xmm0
	mov ebx, rg
	jmp R_WarnOncePerFrame_50
R_WarnOncePerFrame_60:
	movss xmm1, dword [_float_1_00000000]
	jmp R_WarnOncePerFrame_80
	add [eax], al
