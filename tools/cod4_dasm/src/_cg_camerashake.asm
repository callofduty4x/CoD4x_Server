...
CG_ShakeCamera_30:
	mov eax, [ebx+0x46128]
	sub eax, [edx]
	js CG_ShakeCamera_10
	cvtsi2ss xmm3, eax
	movss xmm4, dword [edx+0x8]
	ucomiss xmm3, xmm4
	jb CG_ShakeCamera_20
CG_ShakeCamera_10:
	add ecx, 0x1
	add edx, 0x24
	cmp ecx, 0x4
	jnz CG_ShakeCamera_30
	movss xmm0, dword [ebx+0x50490]
	movss [ebp-0x1c], xmm0
	ucomiss xmm0, xmm5
	jbe CG_ShakeCamera_40
	movaps xmm5, xmm0
	ucomiss xmm7, xmm5
	jae CG_ShakeCamera_50
CG_ShakeCamera_70:
...
CG_ShakeCamera_20:
	...
	mulss xmm1, [edx+0x4]
	ucomiss xmm7, xmm1
	jae CG_ShakeCamera_10
	ucomiss xmm0, xmm7
	jb CG_ShakeCamera_60
	mulss xmm0, xmm1
CG_ShakeCamera_80:
	movss [edx+0x1c], xmm0
	movss [edx+0x20], xmm1
	ucomiss xmm0, xmm5
	jbe CG_ShakeCamera_10
	movaps xmm5, xmm0
	movss [ebp-0x6c], xmm1
	mov edi, [ebp-0x6c]
	jmp CG_ShakeCamera_10
CG_ShakeCamera_40:
	mov [ebp-0x1c], edi
	ucomiss xmm7, xmm5
	jb CG_ShakeCamera_70
CG_ShakeCamera_50:
	call crandom
	fstp dword [ebp-0x34]
...
CG_StartShakeCamera:
	...
	pxor xmm3, xmm3
	ucomiss xmm3, xmm4
	jb CG_StartShakeCamera_10
CG_StartShakeCamera_70:
	movaps xmm1, xmm3
CG_StartShakeCamera_90:
	lea eax, [ecx+ecx*8]
	lea eax, [ecx+eax*4]
	...
	xor ecx, ecx
	cvtsi2ss xmm2, esi
CG_StartShakeCamera_30:
	mov eax, [edx]
	cmp esi, eax
	jl CG_StartShakeCamera_20
	cvtsi2ss xmm0, eax
	addss xmm0, [edx+0x8]
	ucomiss xmm2, xmm0
	jae CG_StartShakeCamera_20
	add ecx, 0x1
	add edx, 0x24
	cmp ecx, 0x4
	jnz CG_StartShakeCamera_30
	mov eax, ebx
	movaps xmm2, xmm3
	xor edx, edx
CG_StartShakeCamera_50:
	movss xmm0, dword [eax+0x1c]
	ucomiss xmm2, xmm0
	jbe CG_StartShakeCamera_40
	mov ecx, edx
	movaps xmm2, xmm0
CG_StartShakeCamera_40:
	add edx, 0x1
	add eax, 0x24
	cmp edx, 0x4
	jnz CG_StartShakeCamera_50
	cmp ecx, 0x4
	jz CG_StartShakeCamera_60
	lea eax, [ecx+ecx*8]
	lea eax, [ebx+eax*4]
	...
	movss [eax+0x20], xmm1
	movss [eax+0x1c], xmm3
CG_StartShakeCamera_60:
	pop ebx
	pop esi
	pop ebp
	ret
CG_StartShakeCamera_10:
	...
	mulss xmm1, [ebp+0xc]
	ucomiss xmm3, xmm1
	jae CG_StartShakeCamera_70
	ucomiss xmm2, xmm3
	jb CG_StartShakeCamera_80
	movaps xmm3, xmm2
	mulss xmm3, xmm1
	jmp CG_StartShakeCamera_90
CG_StartShakeCamera_20:
	movss xmm0, dword [ebp+0x18]
	movss [edx+0xc], xmm0
	movss [edx+0x18], xmm5
	movss [edx+0x14], xmm6
