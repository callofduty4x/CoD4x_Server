;Imports of r_sunshadow:
	...
	extern rgp
	extern gfxMetrics
	extern R_AddWorldSurfacesFrustumOnly
	extern frontEndDataOut
	extern AddPointToBounds2D
	extern rg
	...
	extern R_SetupShadowSurfacesDpvs
...
;Exports of r_sunshadow:
	...
	global R_GetSunShadowMapPartitionViewOrgInTextureSpace
	global R_SetupSunShadowBoundingPoly
	global R_SunShadowMaps
	global R_SetupSunShadowMaps
	global R_MergeAndEmitSunShadowMapsSurfs
...
R_GetSunShadowMapPartitionViewOrgInTextureSpace:
	...
	test al, al
	jz R_GetSunShadowMapPartitionViewOrgInTextureSpace_10
	...
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_GetSunShadowMapPartitionViewOrgInTextureSpace_20
R_GetSunShadowMapPartitionViewOrgInTextureSpace_30:
	movss xmm0, dword [_float_0_00195312]
	mulss xmm0, [ebp-0x20]
	movss [ebx], xmm0
	add esp, 0x2c
	...
	pop ebp
	ret
R_GetSunShadowMapPartitionViewOrgInTextureSpace_10:
	...
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jnz R_GetSunShadowMapPartitionViewOrgInTextureSpace_30
R_GetSunShadowMapPartitionViewOrgInTextureSpace_20:
	movss xmm0, dword [_float_0_00097656]
	mulss xmm0, [ebp-0x20]
	movss [ebx], xmm0
	add esp, 0x2c
...
R_SetupSunShadowBoundingPoly:
	...
	test eax, eax
	jle R_SetupSunShadowBoundingPoly_10
	mov eax, [ebp+0x8]
	add eax, 0x4
	mov [ebp-0xb4], eax
	mov edx, [ebp-0xbc]
	...
	mov ecx, ebx
	xor edi, edi
	jmp R_SetupSunShadowBoundingPoly_20
R_SetupSunShadowBoundingPoly_60:
	jp R_SetupSunShadowBoundingPoly_30
	mov esi, [ebp-0xcc]
	movss xmm0, dword [esi+0x4]
	ucomiss xmm0, [eax+0x4]
	jnz R_SetupSunShadowBoundingPoly_30
	jp R_SetupSunShadowBoundingPoly_30
	mov eax, [ebp-0xac]
	mov dword [eax], 0x1
R_SetupSunShadowBoundingPoly_50:
	add edi, 0x1
	add ebx, 0x8
	add ecx, 0x4
	mov edx, [ebp+0xc]
	cmp edi, [edx+0x8]
	jge R_SetupSunShadowBoundingPoly_40
R_SetupSunShadowBoundingPoly_20:
	lea eax, [edi*8]
	...
	jbe R_SetupSunShadowBoundingPoly_50
	lea edx, [ebp-0xa0]
	add edx, eax
	mov [ebp-0xcc], edx
	movss xmm1, dword [edx]
	mov edx, 0x4
R_SetupSunShadowBoundingPoly_70:
	mov esi, [ebp-0xb8]
	lea eax, [esi+edx*8]
	ucomiss xmm1, [eax]
	jz R_SetupSunShadowBoundingPoly_60
R_SetupSunShadowBoundingPoly_30:
	add edx, 0x1
	cmp [ebp+0x10], edx
	jnz R_SetupSunShadowBoundingPoly_70
	add edi, 0x1
	add ebx, 0x8
	add ecx, 0x4
	mov edx, [ebp+0xc]
	cmp edi, [edx+0x8]
	jl R_SetupSunShadowBoundingPoly_20
R_SetupSunShadowBoundingPoly_40:
	mov esi, [ebp-0xbc]
	...
	pop ebp
	ret
R_SetupSunShadowBoundingPoly_10:
	mov esi, [ebp-0xbc]
	add esi, 0x4
	mov [ebp-0xb0], esi
	mov edx, [ebp+0xc]
	jmp R_SetupSunShadowBoundingPoly_40
	nop
...
R_SunShadowMaps_10:
	...
	mov [esp], ebx
	call R_SetVisData
	call R_AddWorldSurfacesFrustumOnly
	cmp ebx, 0x2
	jnz R_SunShadowMaps_10
	mov [esp], esi
	call R_SetVisData
	add esp, 0x10
	pop ebx
...
R_SetupSunShadowMaps:
	...
	jae R_SetupSunShadowMaps_10
	jp R_SetupSunShadowMaps_10
...
R_SetupSunShadowMaps_330:
	...
	xorps xmm0, xmm7
	ucomiss xmm0, xmm4
	jb R_SetupSunShadowMaps_20
	movaps xmm1, xmm5
R_SetupSunShadowMaps_640:
	mulss xmm3, xmm1
	movss [ebp-0x90], xmm3
	movaps xmm0, xmm1
	mulss xmm0, [ebp-0x8c]
...
R_SetupSunShadowMaps_30:
	...
	jnz R_SetupSunShadowMaps_40
	xor ebx, ebx
R_SetupSunShadowMaps_60:
	lea eax, [ebx+ebx*2]
...
R_SetupSunShadowMaps_80:
	...
	add ebx, 0x1
	cmp ebx, 0x4
	jz R_SetupSunShadowMaps_70
	movss xmm3, dword [ebp-0x20]
	jmp R_SetupSunShadowMaps_80
R_SetupSunShadowMaps_70:
	lea ecx, [ebp-0x78]
	mov [esp+0x8], ecx
	lea ebx, [ebp-0x68]
	mov [esp+0x4], ebx
	...
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_90
	movss xmm0, dword [_float_511_00000000]
R_SetupSunShadowMaps_350:
	...
	mov edx, [ebx+0x22ec]
	test edx, edx
	js R_SetupSunShadowMaps_100
	cvtsi2ss xmm1, edx
R_SetupSunShadowMaps_630:
	movss [ebp-0x2d8], xmm1
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	movss xmm1, dword [ebp-0x2d8]
	jz R_SetupSunShadowMaps_110
	movss xmm0, dword [_float_512_00000000]
R_SetupSunShadowMaps_340:
	divss xmm1, xmm0
	...
	mov eax, vec3_origin
	ucomiss xmm3, [eax]
	jnz R_SetupSunShadowMaps_120
	jp R_SetupSunShadowMaps_120
	ucomiss xmm1, [eax+0x4]
	jz R_SetupSunShadowMaps_130
R_SetupSunShadowMaps_120:
	xor eax, eax
R_SetupSunShadowMaps_380:
	test eax, eax
	setz al
	movzx eax, al
	mov [ebp-0x288], eax
	...
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_140
	movss xmm0, dword [_float_512_00000000]
R_SetupSunShadowMaps_370:
	divss xmm0, dword [ebp-0x254]
	...
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_150
	movss xmm0, dword [_float_512_00000000]
R_SetupSunShadowMaps_360:
	divss xmm0, dword [ebp-0x254]
...
R_SetupSunShadowMaps_400:
	...
	mulss xmm0, [_float_0_50000000]
	ucomiss xmm0, xmm2
	jae R_SetupSunShadowMaps_180
R_SetupSunShadowMaps_570:
	movaps xmm0, xmm1
	subss xmm0, xmm2
	mulss xmm0, [ebp-0x26c]
	addss xmm0, [_float_1_00000000]
...
R_SetupSunShadowMaps_620:
	...
	mov eax, [ebp-0x294]
	mov [edi+0x150], eax
R_SetupSunShadowMaps_600:
	mov edx, rg
	mov eax, [edx+0x22e0]
	test eax, eax
	jnz R_SetupSunShadowMaps_200
	mov ecx, [ebp-0x284]
	mov eax, [ecx+0x144]
	mov [edi+0x144], eax
	mov eax, [ecx+0x148]
...
R_SetupSunShadowMaps_200:
	...
	mov ecx, ebx
	lea edx, [ebp-0x20]
	call R_GetSunShadowMapPartitionViewOrgInTextureSpace
	lea eax, [ebp-0x50]
	lea edx, [ebp-0x40]
	mov [esp], edx
	...
	call R_SetupSunShadowBoundingPoly
	lea ecx, [ebp-0x30]
	lea eax, [ebp-0x154]
...
R_SetupSunShadowMaps_440:
	...
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_220
	movss xmm1, dword [_float_512_00000000]
R_SetupSunShadowMaps_410:
	...
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_230
	movss xmm1, dword [_float_512_00000000]
R_SetupSunShadowMaps_430:
	mulss xmm1, [ebp-0x2a4]
	movss xmm0, dword [_float_2_00000000]
	divss xmm0, xmm1
	movaps xmm2, xmm0
	...
	mov [ebp-0x2f4], ecx
	test ecx, ecx
	jle R_SetupSunShadowMaps_240
	mov ecx, edx
	xor ebx, ebx
R_SetupSunShadowMaps_250:
	lea eax, [ebx*8]
	mov edx, [ebp-0x230]
	add edx, eax
	lea edi, [ebp-0x114]
	...
	add ecx, 0x4
	cmp ebx, [ebp-0x2f4]
	jl R_SetupSunShadowMaps_250
	mov eax, [ebp-0x2f4]
R_SetupSunShadowMaps_420:
	...
	mov ebx, [ecx+0x8]
	test ebx, ebx
	jg R_SetupSunShadowMaps_260
	mov dword [ebp-0x2a0], 0x0
R_SetupSunShadowMaps_810:
	mov ecx, [ebp-0x2a8]
	test ecx, ecx
	jnz R_SetupSunShadowMaps_270
R_SetupSunShadowMaps_480:
	mov edx, [ebp-0x2a8]
	mov [esp+0xc], edx
	mov ecx, [ebp-0x2a0]
	mov [esp+0x8], ecx
	...
	mov [esp+0x4], ebx
	mov [esp], esi
	call R_SetupShadowSurfacesDpvs
	mov eax, rg
	...
	jnz R_SetupSunShadowMaps_280
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_290
	movss xmm1, dword [_float_0_00097656]
	movss [ebp-0x240], xmm1
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_300
R_SetupSunShadowMaps_490:
	movss xmm3, dword [_float_1_00097656]
	movss [ebp-0x23c], xmm3
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_310
R_SetupSunShadowMaps_500:
	movss xmm1, dword [_float_0_50048828]
	movss [ebp-0x238], xmm1
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_320
R_SetupSunShadowMaps_510:
	movss xmm5, dword [_float_0_00048828]
R_SetupSunShadowMaps_520:
...
R_SetupSunShadowMaps_10:
	...
	movaps xmm2, xmm5
	movaps xmm1, xmm4
	jmp R_SetupSunShadowMaps_330
R_SetupSunShadowMaps_110:
	movss xmm0, dword [_float_1024_00000000]
	jmp R_SetupSunShadowMaps_340
R_SetupSunShadowMaps_90:
	movss xmm0, dword [_float_1023_00000000]
	jmp R_SetupSunShadowMaps_350
R_SetupSunShadowMaps_150:
	movss xmm0, dword [_float_1024_00000000]
	jmp R_SetupSunShadowMaps_360
R_SetupSunShadowMaps_140:
	movss xmm0, dword [_float_1024_00000000]
	jmp R_SetupSunShadowMaps_370
R_SetupSunShadowMaps_130:
	jp R_SetupSunShadowMaps_120
	ucomiss xmm2, [eax+0x8]
	jnz R_SetupSunShadowMaps_120
	jp R_SetupSunShadowMaps_120
	mov eax, 0x1
	jmp R_SetupSunShadowMaps_380
R_SetupSunShadowMaps_170:
	mov edx, esi
	add edx, 0x1
	js R_SetupSunShadowMaps_390
	cvtsi2ss xmm0, edx
R_SetupSunShadowMaps_730:
	subss xmm3, [ebp-0x68]
	...
	cmovle eax, esi
	mov [edi+0x144], eax
	jmp R_SetupSunShadowMaps_400
R_SetupSunShadowMaps_220:
	movss xmm1, dword [_float_1024_00000000]
	jmp R_SetupSunShadowMaps_410
R_SetupSunShadowMaps_240:
	mov eax, ecx
	jmp R_SetupSunShadowMaps_420
R_SetupSunShadowMaps_230:
	movss xmm1, dword [_float_1024_00000000]
...
R_SetupSunShadowMaps_460:
	...
	mov edi, [ebp-0x230]
	cmp [edi+0x8], ecx
	jg R_SetupSunShadowMaps_470
	jmp R_SetupSunShadowMaps_480
R_SetupSunShadowMaps_290:
	movss xmm2, dword [_float_0_00048828]
	movss [ebp-0x240], xmm2
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jnz R_SetupSunShadowMaps_490
R_SetupSunShadowMaps_300:
	movss xmm0, dword [_float_1_00048828]
	movss [ebp-0x23c], xmm0
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jnz R_SetupSunShadowMaps_500
R_SetupSunShadowMaps_310:
	movss xmm2, dword [_float_0_50024414]
	movss [ebp-0x238], xmm2
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jnz R_SetupSunShadowMaps_510
R_SetupSunShadowMaps_320:
	movss xmm5, dword [_float_0_00024414]
	jmp R_SetupSunShadowMaps_520
R_SetupSunShadowMaps_270:
	mov edi, rg
	mov edx, [edi+0x22e0]
	test edx, edx
	jz R_SetupSunShadowMaps_480
	mov ebx, [ebp-0x2a0]
	shl ebx, 0x4
...
R_SetupSunShadowMaps_540:
	...
	jz R_SetupSunShadowMaps_530
	mov edx, [ebp-0x234]
	mov [ebp-0x2f0], edx
	mov eax, edx
	jmp R_SetupSunShadowMaps_540
R_SetupSunShadowMaps_160:
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_550
	movss xmm1, dword [_float_511_00000000]
R_SetupSunShadowMaps_660:
...
R_SetupSunShadowMaps_720:
	...
	mulss xmm0, [_float_0_50000000]
	ucomiss xmm0, xmm2
	jb R_SetupSunShadowMaps_570
R_SetupSunShadowMaps_180:
	call _ZN10MacDisplay10Is1900CardEv
	test al, al
	jz R_SetupSunShadowMaps_580
	movss xmm1, dword [_float_511_00000000]
R_SetupSunShadowMaps_650:
	movss xmm2, dword [ebp-0x1c]
	movaps xmm0, xmm2
	subss xmm0, [ebp-0x64]
	mulss xmm0, [ebp-0x26c]
...
R_SetupSunShadowMaps_690:
	...
	mov [edx+0x148], eax
	mov [edi+0x148], esi
	jmp R_SetupSunShadowMaps_600
R_SetupSunShadowMaps_530:
	add dword [ebp-0x2a0], 0x4
	jmp R_SetupSunShadowMaps_480
R_SetupSunShadowMaps_190:
	mov edx, esi
	add edx, 0x1
	js R_SetupSunShadowMaps_610
	cvtsi2ss xmm2, edx
R_SetupSunShadowMaps_740:
	movaps xmm0, xmm1
	subss xmm0, [ebp-0x1c]
	mulss xmm0, [ebp-0x26c]
	...
	cmovl ebx, eax
	mov [edi+0x148], ebx
	jmp R_SetupSunShadowMaps_620
R_SetupSunShadowMaps_100:
	mov eax, edx
	shr eax, 1
	and edx, 0x1
	or eax, edx
	cvtsi2ss xmm1, eax
	addss xmm1, xmm1
	jmp R_SetupSunShadowMaps_630
R_SetupSunShadowMaps_20:
	movaps xmm0, xmm5
	divss xmm0, xmm1
	movaps xmm1, xmm0
	jmp R_SetupSunShadowMaps_640
R_SetupSunShadowMaps_580:
	movss xmm1, dword [_float_1023_00000000]
	jmp R_SetupSunShadowMaps_650
R_SetupSunShadowMaps_550:
	movss xmm1, dword [_float_1023_00000000]
	jmp R_SetupSunShadowMaps_660
R_SetupSunShadowMaps_590:
	mov edx, [ebp-0x294]
	sub edx, 0x1
	js R_SetupSunShadowMaps_670
	cvtsi2ss xmm0, edx
R_SetupSunShadowMaps_750:
	subss xmm2, [ebp-0x64]
	...
	mov eax, [ebp-0x294]
	test eax, eax
	js R_SetupSunShadowMaps_680
	cvtsi2ss xmm1, dword [ebp-0x294]
R_SetupSunShadowMaps_780:
	...
	cmovge eax, edx
	mov [edi+0x150], eax
	jmp R_SetupSunShadowMaps_690
R_SetupSunShadowMaps_560:
	mov edx, [ebp-0x294]
	sub edx, 0x1
	js R_SetupSunShadowMaps_700
	cvtsi2ss xmm1, edx
R_SetupSunShadowMaps_770:
	movaps xmm0, xmm2
	subss xmm0, [ebp-0x20]
	mulss xmm0, [ebp-0x26c]
	mulss xmm0, [ebp-0x28c]
	...
	mov eax, [ebp-0x294]
	test eax, eax
	js R_SetupSunShadowMaps_710
	cvtsi2ss xmm0, dword [ebp-0x294]
R_SetupSunShadowMaps_760:
	subss xmm2, [ebp-0x70]
	mulss xmm2, [ebp-0x26c]
	subss xmm0, xmm2
	movss [esp], xmm0
	...
	cmovge eax, edx
	mov [edi+0x14c], eax
	jmp R_SetupSunShadowMaps_720
R_SetupSunShadowMaps_390:
	mov eax, edx
	shr eax, 1
	and edx, 0x1
	or eax, edx
	cvtsi2ss xmm0, eax
	addss xmm0, xmm0
	jmp R_SetupSunShadowMaps_730
R_SetupSunShadowMaps_610:
	mov eax, edx
	shr eax, 1
	and edx, 0x1
	or eax, edx
	cvtsi2ss xmm2, eax
	addss xmm2, xmm2
	jmp R_SetupSunShadowMaps_740
R_SetupSunShadowMaps_670:
	mov eax, edx
	shr eax, 1
	and edx, 0x1
	or eax, edx
	cvtsi2ss xmm0, eax
	addss xmm0, xmm0
	jmp R_SetupSunShadowMaps_750
R_SetupSunShadowMaps_710:
	mov eax, [ebp-0x294]
	shr eax, 1
	mov edx, [ebp-0x294]
	and edx, 0x1
	...
	cvtsi2ss xmm0, eax
	addss xmm0, xmm0
	jmp R_SetupSunShadowMaps_760
R_SetupSunShadowMaps_700:
	mov eax, edx
	shr eax, 1
	and edx, 0x1
	or eax, edx
	cvtsi2ss xmm1, eax
	addss xmm1, xmm1
	jmp R_SetupSunShadowMaps_770
R_SetupSunShadowMaps_680:
	mov eax, [ebp-0x294]
	shr eax, 1
	...
	cvtsi2ss xmm1, eax
	addss xmm1, xmm1
	jmp R_SetupSunShadowMaps_780
R_SetupSunShadowMaps_450:
	xor eax, eax
	mov dword [ebp-0x2a0], 0x0
	mov edi, rg
	xor ebx, ebx
...
R_SetupSunShadowMaps_820:
	mov edx, [edi+0x22e0]
	test edx, edx
	jz R_SetupSunShadowMaps_790
	mov edx, [ebp+eax*4-0xc4]
	test edx, edx
	jz R_SetupSunShadowMaps_800
R_SetupSunShadowMaps_790:
	lea edx, [eax+0x1]
R_SetupSunShadowMaps_840:
	...
	add dword [ebp-0x2a0], 0x1
	add ecx, 0x10
R_SetupSunShadowMaps_830:
	mov eax, [ebp-0x230]
	cmp edx, [eax+0x8]
	jge R_SetupSunShadowMaps_810
	mov eax, edx
	jmp R_SetupSunShadowMaps_820
R_SetupSunShadowMaps_800:
	lea edx, [eax+0x1]
	cmp dword [ebp+edx*4-0xc4], 0x0
	jz R_SetupSunShadowMaps_830
	jmp R_SetupSunShadowMaps_840
...
R_MergeAndEmitSunShadowMapsSurfs:
	...
	mov edi, [ebp+0x8]
	add edi, 0x5730
R_MergeAndEmitSunShadowMapsSurfs_10:
	lea ebx, [edi+0x154]
	mov [esp], ebx
	...
	cmp eax, 0x2
	jnz R_MergeAndEmitSunShadowMapsSurfs_10
	add esp, 0x2c
	pop ebx
	pop esi
	pop edi
