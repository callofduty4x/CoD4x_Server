...
SearchForApplication_40:
	...
	call FSOpenIterator
	test ax, ax
	jz SearchForApplication_10
	cmp byte [ebp-0x179], 0x0
	jz SearchForApplication_20
SearchForApplication_150:
	mov ecx, [ebp-0x30]
	mov ebx, ecx
	mov edx, [ebp-0x2c]
	cmp ecx, edx
	jz SearchForApplication_30
	lea esi, [ebp-0x80]
SearchForApplication_60:
	...
	mov edx, [ebp-0x178]
	mov eax, esi
	call SearchForApplication_40
	test al, al
	jnz SearchForApplication_50
	add ebx, 0x50
	mov edx, [ebp-0x2c]
	cmp ebx, edx
	jnz SearchForApplication_60
	mov ecx, [ebp-0x30]
SearchForApplication_30:
	xor ebx, ebx
SearchForApplication_200:
	mov eax, ecx
	cmp edx, ecx
	jz SearchForApplication_70
SearchForApplication_80:
	add eax, 0x50
	cmp edx, eax
	jnz SearchForApplication_80
SearchForApplication_70:
	test ecx, ecx
	jz SearchForApplication_90
	mov [esp], ecx
	call _ZdlPv
SearchForApplication_90:
	mov eax, [ebp-0x16c]
	test eax, eax
	jz SearchForApplication_100
	mov eax, [ebp-0x16c]
	mov [esp], eax
	call _ZdaPv
SearchForApplication_100:
	mov edi, [ebp-0x170]
	test edi, edi
	jz SearchForApplication_110
	mov eax, [ebp-0x170]
	mov [esp], eax
	call _ZdaPv
SearchForApplication_110:
	mov eax, ebx
	add esp, 0x1ac
	pop ebx
	pop esi
	...
	pop ebp
	ret
SearchForApplication_140:
	mov eax, [ebp-0x24]
	test eax, eax
	jnz SearchForApplication_120
SearchForApplication_170:
	cmp word [ebp-0x172], 0x0
	jnz SearchForApplication_130
SearchForApplication_10:
	...
	mov [ebp-0x172], ax
	test ax, ax
	jz SearchForApplication_140
	cmp ax, 0xfa77
	jz SearchForApplication_140
SearchForApplication_130:
	mov eax, [ebp-0x20]
	mov [esp], eax
	call FSCloseIterator
	cmp byte [ebp-0x179], 0x0
	jnz SearchForApplication_150
SearchForApplication_20:
	mov edx, [ebp-0x2c]
	mov ecx, [ebp-0x30]
	jmp SearchForApplication_30
SearchForApplication_120:
	mov ebx, [ebp-0x170]
	mov esi, [ebp-0x16c]
	xor edi, edi
	jmp SearchForApplication_160
SearchForApplication_180:
	add edi, 0x1
	add ebx, 0x90
	add esi, 0x50
	cmp edi, [ebp-0x24]
	jae SearchForApplication_170
SearchForApplication_160:
	...
	test eax, eax
	jnz SearchForApplication_180
	mov eax, [ebp-0x80]
	test al, 0x40
	jnz SearchForApplication_180
	test al, 0x2
	jz SearchForApplication_190
	test al, 0x4
	jz SearchForApplication_180
	mov eax, [ebp-0x178]
	cmp eax, [ebp-0x78]
	...
	mov edx, [ebp-0x2c]
	mov ecx, [ebp-0x30]
	jmp SearchForApplication_200
SearchForApplication_190:
	cmp byte [ebp-0x179], 0x0
	jz SearchForApplication_180
	mov edx, [ebp-0x2c]
	cmp edx, [ebp-0x28]
	jz SearchForApplication_210
	test edx, edx
	jz SearchForApplication_220
	mov dword [esp+0x8], 0x50
	lea eax, [ebp-0xd0]
	mov [esp+0x4], eax
	mov [esp], edx
	call memcpy
	mov edx, [ebp-0x2c]
SearchForApplication_220:
	add edx, 0x50
	mov [ebp-0x2c], edx
	jmp SearchForApplication_180
SearchForApplication_50:
	mov ebx, 0x1
	mov edx, [ebp-0x2c]
	mov ecx, [ebp-0x30]
	jmp SearchForApplication_200
SearchForApplication_210:
	lea eax, [ebp-0xd0]
	mov [esp+0x8], eax
	mov [esp+0x4], edx
	lea eax, [ebp-0x30]
	...
	jmp SearchForApplication_180
	mov ebx, eax
SearchForApplication_270:
	mov esi, [ebp-0x170]
	test esi, esi
	jz SearchForApplication_230
	mov eax, [ebp-0x170]
	mov [esp], eax
	call _ZdaPv
SearchForApplication_230:
	mov [esp], ebx
	call _Unwind_Resume
	mov ebx, eax
	mov edx, [ebp-0x2c]
	...
	mov eax, ecx
	cmp edx, ecx
	jz SearchForApplication_240
SearchForApplication_250:
	add eax, 0x50
	cmp edx, eax
	jnz SearchForApplication_250
SearchForApplication_240:
	test ecx, ecx
	jz SearchForApplication_260
	mov [esp], ecx
	call _ZdlPv
SearchForApplication_260:
	mov eax, [ebp-0x16c]
	test eax, eax
	jz SearchForApplication_270
	mov eax, [ebp-0x16c]
	mov [esp], eax
	call _ZdaPv
	jmp SearchForApplication_270
	nop
