...
;Exports of r_pixelcost_load_obj:
	...
	global R_PixelCost_PrintColorCodeKey
	global RB_PixelCost_BuildColorCodeMap
...
R_PixelCost_PrintColorCodeKey_10:
	mov eax, [ebx+0x4]
	mov [esp+0x10], eax
	movzx eax, byte [ebx]
	cvtsi2ss xmm0, eax
	...
	jnz R_PixelCost_PrintColorCodeKey_10
...
RB_PixelCost_BuildColorCodeMap:
	push ebp
	mov ebp, esp
	push edi
	push esi
	...
	jmp RB_PixelCost_BuildColorCodeMap_10
RB_PixelCost_BuildColorCodeMap_30:
	...
	jz RB_PixelCost_BuildColorCodeMap_20
RB_PixelCost_BuildColorCodeMap_10:
	mov esi, [ebp-0x24]
	add esi, 0x1
	movzx eax, byte [esi*8+s_pixelCostColorCodeTable]
	cmp eax, [ebp-0x20]
	jz RB_PixelCost_BuildColorCodeMap_30
	mov ecx, [ebp-0x24]
	shl ecx, 0x3
	...
	add edi, 0x4
	cmp dword [ebp-0x20], 0x100
	jnz RB_PixelCost_BuildColorCodeMap_10
RB_PixelCost_BuildColorCodeMap_20:
	add esp, 0x4c
	pop ebx
	pop esi
	pop edi
