;Imports of r_spu_draw:

;Exports of r_spu_draw:
	global _GLOBAL__I_marker_r_spu_draw


SECTION .text


;global constructors keyed to marker_r_spu_draw
_GLOBAL__I_marker_r_spu_draw:
	push ebp
	mov ebp, esp
	mov edx, 0xffff
	mov eax, 0x1
...
;Initialized global or static variables of r_spu_draw:
SECTION .data


;Initialized constant data of r_spu_draw:
SECTION .rdata
...
;Zero initialized global or static variables of r_spu_draw:
SECTION .bss
g_keepZ: resb 0x10
g_keepX: resb 0x10
g_keepZW: resb 0x10
