;Imports of r_water_load_obj:
	...
	extern exp
	extern GaussianRandom
	extern va
	extern R_CreateWaterMap
	extern Com_PrintError

;Exports of r_water_load_obj:
	global sceneWaterMapSetupsCount
	global sceneWaterMapSetups
	global R_InitLoadWater
	global R_LoadWaterSetup
	global R_ShutdownLoadWater
...
R_LoadWaterSetup:
	...
	jmp R_LoadWaterSetup_20
R_LoadWaterSetup_40:
	add ecx, 0x1
	add edx, 0x44
	cmp ecx, [ebp-0x2c]
	jz R_LoadWaterSetup_30
R_LoadWaterSetup_20:
	cmp [edx+0xc], ebx
	jnz R_LoadWaterSetup_40
	mov eax, [edx+0x10]
	mov edi, [ebp+0x8]
	cmp eax, [edi+0x10]
	jnz R_LoadWaterSetup_40
	...
	ja R_LoadWaterSetup_40
	mov edi, edx
	jmp R_LoadWaterSetup_50
R_LoadWaterSetup_10:
	mov dword [ebp-0x2c], 0x0
	mov eax, [ebp+0x8]
	mov ebx, [eax+0xc]
R_LoadWaterSetup_120:
	mov eax, [ebp-0x2c]
	shl eax, 0x6
	mov edx, [ebp-0x2c]
	...
	sar eax, 1
	cmp [ebp-0x4c], eax
	jge R_LoadWaterSetup_60
	mov dword [ebp-0x3c], 0x0
	mov ecx, [edi+0xc]
	jmp R_LoadWaterSetup_70
R_LoadWaterSetup_80:
...
R_LoadWaterSetup_70:
	...
	shl eax, 0x2
	mov [ebp-0x30], eax
	jmp R_LoadWaterSetup_90
R_LoadWaterSetup_110:
...
R_LoadWaterSetup_90:
	...
	sar eax, 1
	cmp ebx, eax
	jl R_LoadWaterSetup_90
R_LoadWaterSetup_100:
	mov esi, [edi+0x10]
	add dword [ebp-0x4c], 0x1
	mov eax, esi
	shr eax, 0x1f
