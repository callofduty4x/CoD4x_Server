...
PM_SlideMove_160:
	...
	xorps xmm0, [_ZZ14PM_GetMoveAnimP13playerState_s17PmStanceFrontBackiiE13moveAnimTable+0x1a0]
	mov edx, [ebp-0x154]
...
PM_StepSlideMove_350:
	...
	subss xmm1, [ebp-0x2c]
	movaps xmm0, xmm1
	andps xmm0, [_ZZ14PM_GetMoveAnimP13playerState_s17PmStanceFrontBackiiE13moveAnimTable+0x1b0]
