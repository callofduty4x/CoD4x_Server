...
CM_AreaEntities_r_60:
	...
	mov eax, [edi+0x4]
	test [esi+0x14], eax
	jz CM_AreaEntities_r_10
CM_AreaEntities_r_50:
	movzx eax, word [edi+0xc]
	movzx edx, ax
	test ax, ax
	jnz CM_AreaEntities_r_20
CM_AreaEntities_r_100:
	...
	ucomiss xmm0, xmm1
	jbe CM_AreaEntities_r_30
	mov eax, [esi]
	ucomiss xmm1, [edx+eax]
	ja CM_AreaEntities_r_40
	...
	mov eax, [edi+0x4]
	test [esi+0x14], eax
	jnz CM_AreaEntities_r_50
CM_AreaEntities_r_10:
	add esp, 0x2c
	pop ebx
	pop esi
	pop edi
	pop ebp
	ret
CM_AreaEntities_r_30:
	mov eax, [esi]
	movss xmm0, dword [edx+eax]
	ucomiss xmm0, xmm1
	jae CM_AreaEntities_r_10
	movzx ecx, word [edi+0x1a]
	jmp CM_AreaEntities_r_60
CM_AreaEntities_r_20:
	mov eax, [ebp-0x24]
	mov [ebp-0x20], eax
	mov eax, [ebp-0x28]
	mov [ebp-0x1c], eax
CM_AreaEntities_r_90:
	lea eax, [edx+edx*2]
	shl eax, 0x4
	sub eax, edx
	mov edx, [ebp-0x20]
	...
	mov eax, [eax+0x120]
	test [esi+0x14], eax
	jz CM_AreaEntities_r_70
	mov eax, [esi+0x4]
	movss xmm0, dword [edx+0x124]
	ucomiss xmm0, [eax]
	ja CM_AreaEntities_r_70
	mov ecx, [esi]
...
CM_AreaEntities_r_70:
	movzx eax, word [ebx+0x2]
	movzx edx, ax
	test ax, ax
	jnz CM_AreaEntities_r_90
	jmp CM_AreaEntities_r_100
CM_AreaEntities_r_40:
	movzx ebx, word [edi+0x1a]
	movzx eax, word [edi+0x18]
	mov edx, esi
	call CM_AreaEntities_r_110
	mov ecx, ebx
	jmp CM_AreaEntities_r_60
CM_AreaEntities_r_80:
	mov dword [esp+0x4], _cstring_cm_areaentities_
	mov dword [esp], 0x10
	call Com_DPrintf
	jmp CM_AreaEntities_r_10
