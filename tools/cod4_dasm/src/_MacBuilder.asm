...
;Exports of MacBuilder:
	...
	global HandleStandardEvents
	global ValidationProc
	global KeyFilterProc
	...
	global HandleUppercaseHook
	global UserPaneHitTestProc
...
HandleStandardEvents:
	...
	call GetEventClass
	cmp eax, 0x636d6473
	jz HandleStandardEvents_10
	jbe HandleStandardEvents_20
	cmp eax, 0x6d6f7573
	jz HandleStandardEvents_30
	cmp eax, 0x77696e64
	jz HandleStandardEvents_40
HandleStandardEvents_50:
	mov ebx, 0xffffd96e
HandleStandardEvents_80:
	mov eax, ebx
	add esp, 0x40
	pop ebx
	pop esi
	pop ebp
	ret
HandleStandardEvents_20:
	cmp eax, 0x50726976
	jnz HandleStandardEvents_50
	cmp ebx, 0x41647643
	jnz HandleStandardEvents_50
	lea eax, [ebp-0xc]
	mov [esp+0x18], eax
	...
	jmp HandleStandardEvents_50
HandleStandardEvents_10:
	cmp ebx, 0x1
	jnz HandleStandardEvents_50
	lea eax, [ebp-0x1a]
	mov [esp+0x18], eax
	...
	mov eax, [ebp-0x16]
	cmp eax, 0x6f6b2020
	jz HandleStandardEvents_60
	cmp eax, 0x6e6f7421
	jnz HandleStandardEvents_70
	...
	xor ebx, ebx
	jmp HandleStandardEvents_80
HandleStandardEvents_40:
	cmp ebx, 0x48
	jnz HandleStandardEvents_50
	mov eax, [sBuilderProcPtr]
	test eax, eax
	jz HandleStandardEvents_90
...
HandleStandardEvents_30:
	...
	mov ebx, eax
	test eax, eax
	jnz HandleStandardEvents_100
	mov edx, [ebp-0xc]
	test edx, edx
	jz HandleStandardEvents_110
	lea eax, [ebp-0x1a]
	mov [esp+0x4], eax
	mov [esp], edx
	call GetControlKind
	...
	mov eax, [ebp-0x16]
	cmp eax, 0x65747874
	jz HandleStandardEvents_120
	cmp eax, 0x65757478
	jz HandleStandardEvents_120
HandleStandardEvents_110:
	xor ebx, ebx
HandleStandardEvents_100:
	xor eax, eax
HandleStandardEvents_130:
	mov [esp], eax
	call SetThemeCursor
	jmp HandleStandardEvents_80
HandleStandardEvents_120:
	mov eax, 0x4
	jmp HandleStandardEvents_130
HandleStandardEvents_70:
	mov edx, [sBuilderProcPtr]
	test edx, edx
	jz HandleStandardEvents_50
	...
	test al, al
	jz HandleStandardEvents_50
HandleStandardEvents_90:
	xor ebx, ebx
	jmp HandleStandardEvents_80
HandleStandardEvents_60:
...
ValidationProc_10:
	...
	test ax, ax
	jz ValidationProc_20
	xor eax, eax
ValidationProc_40:
	movsx edx, ax
	movzx eax, bx
	cmp edx, eax
	jle ValidationProc_30
	mov [ebp-0x10], bx
...
KeyFilterProc_10:
	...
	jnz KeyFilterProc_30
	movzx eax, word [esi]
	cmp ax, 0x1f
	jle KeyFilterProc_40
	cmp ax, 0x7f
	jz KeyFilterProc_30
KeyFilterProc_80:
	mov dword [esp+0x14], 0x0
...
KeyFilterProc_40:
	cmp ax, 0x1c
	jge KeyFilterProc_30
	sub eax, 0x8
	cmp ax, 0x1
	ja KeyFilterProc_80
	jmp KeyFilterProc_30
KeyFilterProc_50:
	movzx esi, word [ebp-0x1c]
	sub si, [ebp-0x1a]
	jmp KeyFilterProc_90
KeyFilterProc_60:
	movzx eax, word [ebp-0x20]
	jmp KeyFilterProc_100
...
HandleUppercaseHook:
	...
	call GetEventParameter
	test eax, eax
	jnz HandleUppercaseHook_10
	cmp dword [ebp-0x1c], 0x75746638
	jz HandleUppercaseHook_20
HandleUppercaseHook_10:
	mov eax, 0xffffd96e
	add esp, 0xbc
	pop ebx
	pop esi
...
_ZN10MacBuilder11BuildWindowEPK10__CFStringS2_hPFhP15OpaqueWindowPtrmE_30:
	...
	mov dword [esp+0x4], HandleStandardEvents
	mov [esp], eax
...
_ZN10MacBuilder20SetupUserPaneControlEP15OpaqueWindowPtrlPFvP16OpaqueControlRefsEPFsS3_5PointS5_E:
	...
	test edi, edi
	jz _ZN10MacBuilder20SetupUserPaneControlEP15OpaqueWindowPtrlPFvP16OpaqueControlRefsEPFsS3_5PointS5_E_10
	mov dword [esp], UserPaneHitTestProc
...
_ZN10MacBuilder24SetEditTextUppercaseHookEP15OpaqueWindowPtrl:
	...
	mov dword [esp+0x4], HandleUppercaseHook
	mov [esp], eax
	call InstallEventHandler
