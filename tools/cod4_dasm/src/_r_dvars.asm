...
;Exports of r_dvars:
	...
	global R_RegisterDvars
	global R_CheckDvarModified
	global r_fullscreen
	global r_pretess
...
R_RegisterDvars:
	...
	pop edi
	pop ebp
	jmp R_ReflectionProbeRegisterDvars
...
R_CheckDvarModified:
	...
	jnz R_CheckDvarModified_10
	xor eax, eax
	leave
	ret
R_CheckDvarModified_10:
	mov [esp], eax
