...
G_RadiusDamage_50:
	...
	addss xmm1, [ebp+0x18]
	mov dword [esp+0x14], g_clients+0x9be11
	mov eax, [ebp+0x24]
	mov [esp+0x10], eax
	movss xmm0, dword [ebp+0x20]
	movss [esp+0xc], xmm0
...
CanDamage_360:
	...
	sqrtss xmm1, xmm0
	movaps xmm0, xmm1
	xorps xmm0, [_ZZ11Melee_TraceP9gentity_sP11weaponParmsifffP7trace_tPfE12traceOffsets+0x2e0]
	pxor xmm5, xmm5
	ucomiss xmm0, xmm5
	jb CanDamage_30
	movss xmm0, dword [_float_1_00000000]
CanDamage_390:
	...
	mulss xmm5, xmm0
	mulss xmm4, xmm0
	xorps xmm4, [_ZZ11Melee_TraceP9gentity_sP11weaponParmsifffP7trace_tPfE12traceOffsets+0x2e0]
	movss xmm0, dword [ebp-0x24]
	addss xmm0, [eax]
...
CanDamage_430:
	...
	mulss xmm4, xmm0
	movaps xmm6, xmm2
	xorps xmm6, [_ZZ11Melee_TraceP9gentity_sP11weaponParmsifffP7trace_tPfE12traceOffsets+0x2e0]
	movaps xmm0, xmm6
	mulss xmm0, xmm6
	movaps xmm1, xmm5
	mulss xmm1, xmm5
...
CanDamage_440:
	...
	movss [ebp-0x58], xmm0
	movaps xmm1, xmm6
	xorps xmm1, [_ZZ11Melee_TraceP9gentity_sP11weaponParmsifffP7trace_tPfE12traceOffsets+0x2e0]
	addss xmm1, [ebp-0x6c]
	movss [ebp-0x54], xmm1
	...
	movss [ebp-0xa4], xmm0
	movss [ebp-0x50], xmm0
	xorps xmm7, [_ZZ11Melee_TraceP9gentity_sP11weaponParmsifffP7trace_tPfE12traceOffsets+0x2e0]
	addss xmm7, [ebx]
	movaps xmm0, xmm3
	addss xmm0, xmm1
	movss [ebp-0x54], xmm0
	...
	movss [ebp-0x4c], xmm0
	addss xmm6, [ebp-0x6c]
	xorps xmm3, [_ZZ11Melee_TraceP9gentity_sP11weaponParmsifffP7trace_tPfE12traceOffsets+0x2e0]
	movaps xmm0, xmm3
	addss xmm0, xmm6
	movss [ebp-0x48], xmm0
	xorps xmm4, [_ZZ11Melee_TraceP9gentity_sP11weaponParmsifffP7trace_tPfE12traceOffsets+0x2e0]
	...
	addss xmm0, [ebp-0x44]
	movss [ebp-0x44], xmm0
	xorps xmm5, [_ZZ11Melee_TraceP9gentity_sP11weaponParmsifffP7trace_tPfE12traceOffsets+0x2e0]
	movaps xmm0, xmm5
	addss xmm0, xmm2
	movss [ebp-0x40], xmm0
	movss [ebp-0x3c], xmm1
