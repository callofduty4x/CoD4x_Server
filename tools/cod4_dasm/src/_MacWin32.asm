...
SetThreadPriority:
	...
	test eax, eax
	jnz SetThreadPriority_10
	mov eax, [ebp+0xc]
	add eax, 0xf
	cmp eax, 0x1e
	jbe SetThreadPriority_20
SetThreadPriority_30:
	mov [esp+0x8], ebx
	mov eax, [ebp-0xc]
	mov [esp+0x4], eax
	mov [esp], esi
	call pthread_setschedparam
SetThreadPriority_10:
	test eax, eax
	setz al
	movzx eax, al
	add esp, 0x20
	...
	pop ebp
	ret
SetThreadPriority_20:
	jmp dword [eax*4+SetThreadPriority_jumptab_0]
SetThreadPriority_50:
	mov eax, [ebp-0xc]
	mov [esp], eax
	call sched_get_priority_min
	mov [ebp-0x14], eax
	jmp SetThreadPriority_30
SetThreadPriority_60:
	mov eax, [ebp-0xc]
	mov [esp], eax
	call sched_get_priority_min
SetThreadPriority_40:
	add eax, 0x1f
	mov edx, eax
	shr edx, 0x1f
	add edx, eax
	...
	mov [ebp-0x14], edx
	jmp SetThreadPriority_30
SetThreadPriority_70:
	mov dword [ebp-0x14], 0x1f
	jmp SetThreadPriority_30
SetThreadPriority_90:
	mov eax, [ebp-0xc]
	mov [esp], eax
	call sched_get_priority_max
	mov [ebp-0x14], eax
	jmp SetThreadPriority_30
SetThreadPriority_80:
	mov eax, [ebp-0xc]
	mov [esp], eax
	call sched_get_priority_max
	jmp SetThreadPriority_40
	nop
	
	
SetThreadPriority_jumptab_0:
	dd SetThreadPriority_50
	dd SetThreadPriority_30
	dd SetThreadPriority_30
	dd SetThreadPriority_30
	dd SetThreadPriority_30
	dd SetThreadPriority_30
	...
	dd SetThreadPriority_30
	dd SetThreadPriority_50
	dd SetThreadPriority_60
	dd SetThreadPriority_70
	dd SetThreadPriority_80
	dd SetThreadPriority_90
	dd SetThreadPriority_30
	dd SetThreadPriority_30
	dd SetThreadPriority_30
	dd SetThreadPriority_30
