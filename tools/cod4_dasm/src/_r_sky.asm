...
;Exports of r_sky:
	global R_FlushSun
	global R_Cmd_LoadSun
	global R_Cmd_SaveSun
	global R_SetSunFromDvars
	global R_RegisterSunDvars
	global R_LoadSunThroughDvars
...
R_LoadSunThroughDvars:
	...
	test eax, eax
	jnz R_LoadSunThroughDvars_20
R_LoadSunThroughDvars_30:
	mov eax, [ebp-0xc]
	mov [esp], eax
	call FS_FreeFile
	add esp, 0x24
	...
	pop ebp
	ret
R_LoadSunThroughDvars_20:
	mov eax, [ebp+0xc]
	mov [esp], eax
	call R_SetSunFromDvars
	jmp R_LoadSunThroughDvars_30
R_LoadSunThroughDvars_10:
	mov [esp+0x8], ebx
