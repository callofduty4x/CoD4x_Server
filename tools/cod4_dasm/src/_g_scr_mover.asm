...
ScriptMover_UpdateMove_20:
	...
	sqrtss xmm1, xmm0
	movaps xmm0, xmm1
	xorps xmm0, [_ZZ13MissileImpactP9gentity_sP7trace_tPfS3_E19MY_STRAIGHTUPNORMAL+0xb0]
	ucomiss xmm0, xmm6
...
ScriptEntCmd_Vibrate_30:
	...
	sqrtss xmm1, xmm1
	movaps xmm0, xmm1
	xorps xmm0, [_ZZ13MissileImpactP9gentity_sP7trace_tPfS3_E19MY_STRAIGHTUPNORMAL+0xa0]
...
ScriptEntCmd_Vibrate_60:
	...
	mulss xmm3, [ebp-0x24]
	addss xmm1, xmm3
	xorps xmm1, [_ZZ13MissileImpactP9gentity_sP7trace_tPfS3_E19MY_STRAIGHTUPNORMAL+0xa0]
	lea edx, [ebx+0x208]
	mov eax, [ebx+0x148]
	mov [ebx+0x208], eax
	mov eax, [ebx+0x14c]
