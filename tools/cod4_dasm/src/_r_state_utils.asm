;Imports of r_state_utils:
	...
	extern R_SetGameTime
	extern memset
	extern R_SetCompleteState
...
;Exports of r_state_utils:
	...
	global R_BeginView
	global R_CmdBufSet3D
	global R_InitCmdBufState
	global R_GetActiveWorldMatrix
	global R_InitCmdBufSourceState
	global R_SetShadowLookupMatrix
	global R_Set2D
	global R_Set3D
...
R_InitCmdBufState:
	...
	mov [ebp-0x2c], eax
	mov edx, [ebp-0x1c]
	and edx, _cstring_olprio_pain
	shr edx, 0x14
	mov [ebp-0x28], edx
	mov ecx, [ebp-0x1c]
	and ecx, g_xAnimInfo+0x20360
	shr ecx, 0x16
	mov [ebp-0x24], ecx
	mov eax, [ebp-0x1c]
	and eax, 0x3000000
...
R_InitCmdBufState_20:
	...
	jle R_InitCmdBufState_10
	mov eax, esi
	add eax, [ecx+0x3a0]
	mov edx, [ebp-0x30]
	mov [eax+0x28], edx
	or [ecx+0x444], ebx
R_InitCmdBufState_10:
	mov eax, esi
	mov ecx, [ebp-0x4c]
	add eax, [ecx+0x3a0]
	mov edx, [ebp-0x2c]
...
R_InitCmdBufSourceState:
	...
	jnz R_InitCmdBufSourceState_10
	xor edx, edx
	lea eax, [esi+0x880]
R_InitCmdBufSourceState_20:
	...
	add eax, 0x10
	cmp edx, 0x3a
	jnz R_InitCmdBufSourceState_20
R_InitCmdBufSourceState_50:
	mov eax, 0x3f800000
	mov [esi+0xf20], eax
	mov [esi+0xf30], eax
	mov eax, [ebp+0x10]
	...
	pop ebp
	ret
R_InitCmdBufSourceState_10:
	mov edx, esi
	xor ebx, ebx
	mov ecx, s_codeConstUpdateFreq
	mov eax, edi
R_InitCmdBufSourceState_40:
	cmp dword [ecx], 0x2
	jz R_InitCmdBufSourceState_30
R_InitCmdBufSourceState_60:
	mov dword [eax], 0x7f7fffff
	mov dword [eax+0x4], 0x7f7fffff
	mov dword [eax+0x8], 0x7f7fffff
	mov dword [eax+0xc], 0x0
R_InitCmdBufSourceState_70:
	add ebx, 0x1
	add eax, 0x10
	add edx, 0x2
	add ecx, 0x4
	cmp ebx, 0x3a
	jnz R_InitCmdBufSourceState_40
	jmp R_InitCmdBufSourceState_50
R_InitCmdBufSourceState_30:
	cmp ebx, 0x1f
	jbe R_InitCmdBufSourceState_60
	mov word [edx+0xe30], 0x1
	jmp R_InitCmdBufSourceState_70


;R_SetShadowLookupMatrix(GfxCmdBufSourceState*, GfxMatrix const*)
R_SetShadowLookupMatrix:
	push ebp
	mov ebp, esp
	mov eax, [ebp+0x8]
	mov edx, [ebp+0xc]
