...
;Exports of r_staticmodelcache_load_obj:
	global R_CompareSModelStats_Score
	global R_CompareSModels_Model
	global R_AssignSModelCacheResources
...
R_AssignSModelCacheResources:
	...
	mov eax, [edx+0x244]
	test eax, eax
	jnz R_AssignSModelCacheResources_10
	mov dword [ebp-0x20ec], 0x0
R_AssignSModelCacheResources_290:
	mov eax, [ebp-0x20ec]
	shl eax, 0x4
	lea ebx, [ebp-0x204c]
	add ebx, eax
	...
	lea esi, [ebp-0x204c]
	cmp esi, ebx
	jz R_AssignSModelCacheResources_20
	sub ebx, esi
	mov eax, ebx
	sar eax, 0x4
	cmp eax, 0x1
	jz R_AssignSModelCacheResources_30
	xor edx, edx
R_AssignSModelCacheResources_40:
	add edx, 0x1
	sar eax, 1
	cmp eax, 0x1
	jnz R_AssignSModelCacheResources_40
	lea eax, [edx+edx]
R_AssignSModelCacheResources_350:
	mov dword [esp+0xc], R_CompareSModelStats_Score
	mov [esp+0x8], eax
	mov edx, [ebp-0x2094]
	mov [esp+0x4], edx
	lea ecx, [ebp-0x204c]
	...
	cmp ebx, 0x10f
	jle R_AssignSModelCacheResources_50
	mov dword [esp+0x8], R_CompareSModelStats_Score
	lea ebx, [ebp-0x1f4c]
	mov [esp+0x4], ebx
	lea esi, [ebp-0x204c]
	mov [esp], esi
	...
	lea edi, [ebp-0x1f40]
	mov esi, ebx
R_AssignSModelCacheResources_80:
	mov edx, [edi-0x4]
	mov ecx, [edi-0x8]
	mov ebx, [edi-0xc]
	mov eax, [edi]
	...
	mov ebx, [ebp-0x2090]
	sub ebx, 0x10
	jmp R_AssignSModelCacheResources_60
R_AssignSModelCacheResources_70:
	mov eax, [ebx]
	mov [esi], eax
	mov eax, [ebx+0x4]
	mov [esi+0x4], eax
	...
	mov esi, ebx
	sub ebx, 0x10
R_AssignSModelCacheResources_60:
	mov [esp+0x4], ebx
	lea eax, [ebp-0x4c]
	mov [esp], eax
	call R_CompareSModelStats_Score
	test al, al
	jnz R_AssignSModelCacheResources_70
	mov eax, [ebp-0x4c]
	mov [esi], eax
	mov eax, [ebp-0x48]
	mov [esi+0x4], eax
	...
	jz R_AssignSModelCacheResources_20
	mov esi, [ebp-0x2090]
	jmp R_AssignSModelCacheResources_80
R_AssignSModelCacheResources_50:
	mov dword [esp+0x8], R_CompareSModelStats_Score
	mov ecx, [ebp-0x2094]
	mov [esp+0x4], ecx
	lea ebx, [ebp-0x204c]
	mov [esp], ebx
	call _ZSt16__insertion_sortIP18GfxSModelSurfStatsPFhRKS0_S3_EEvT_S6_T0_
R_AssignSModelCacheResources_20:
	mov ebx, [ebp-0x20ec]
	test ebx, ebx
	jz R_AssignSModelCacheResources_90
	...
	mov edx, esi
	mov ebx, esi
R_AssignSModelCacheResources_120:
	mov eax, [eax]
	mov [ebp-0x20e4], eax
	mov edx, [edx+0x4]
	mov [ebp-0x20e0], edx
	...
	mov ebx, 0x1
	mov esi, 0x4
R_AssignSModelCacheResources_110:
	lea edx, [ebp-0x3c]
	lea ecx, [esi+edx]
	mov eax, [ebp-0x2068]
	...
	cmp eax, [edx]
	jae R_AssignSModelCacheResources_100
	mov [ebp-0x2068], ebx
R_AssignSModelCacheResources_130:
	add ebx, 0x1
	add esi, 0x4
	cmp ebx, 0x4
	jnz R_AssignSModelCacheResources_110
	add [ecx], edi
	mov edx, [ebp-0x206c]
	mov eax, [edx]
	mov [esp+0xc], eax
	...
	mov ebx, [ebp-0x20e4]
	mov [esp], ebx
	call XModelSetSModelCacheForLod
	...
	mov edx, [ebp-0x2070]
	mov ebx, [ebp-0x20f0]
	jmp R_AssignSModelCacheResources_120
R_AssignSModelCacheResources_100:
	mov ecx, edx
	jmp R_AssignSModelCacheResources_130
R_AssignSModelCacheResources_90:
	add esp, 0x20fc
	pop ebx
	pop esi
	pop edi
	pop ebp
	ret
R_AssignSModelCacheResources_10:
	shl eax, 0x2
	mov [esp], eax
	...
	mov eax, [ecx+0x244]
	test eax, eax
	jz R_AssignSModelCacheResources_140
	xor edx, edx
	xor ecx, ecx
R_AssignSModelCacheResources_150:
	mov eax, ecx
	mov ebx, [ebp+0x8]
	add eax, [ebx+0x29c]
	mov esi, [ebp-0x20d8]
	...
	add ecx, 0x4c
	cmp edx, [ebx+0x244]
	jnz R_AssignSModelCacheResources_150
	lea eax, [edx*4]
R_AssignSModelCacheResources_620:
	add eax, [ebp-0x20d8]
	mov [ebp-0x20d4], eax
	cmp [ebp-0x20d8], eax
	jz R_AssignSModelCacheResources_160
	mov ebx, eax
	sub ebx, [ebp-0x20d8]
	mov eax, ebx
	sar eax, 0x2
	cmp eax, 0x1
	jz R_AssignSModelCacheResources_170
	xor edx, edx
R_AssignSModelCacheResources_180:
	add edx, 0x1
	sar eax, 1
	cmp eax, 0x1
	jnz R_AssignSModelCacheResources_180
	lea eax, [edx+edx]
R_AssignSModelCacheResources_510:
	mov dword [esp+0xc], R_CompareSModels_Model
	mov [esp+0x8], eax
	mov eax, [ebp-0x20d4]
	mov [esp+0x4], eax
	mov edx, [ebp-0x20d8]
	...
	cmp ebx, 0x43
	jle R_AssignSModelCacheResources_190
	mov ecx, [ebp-0x20d8]
	add ecx, 0x40
	mov [ebp-0x20cc], ecx
	mov dword [esp+0x8], R_CompareSModels_Model
	mov [esp+0x4], ecx
	mov ebx, [ebp-0x20d8]
	mov [esp], ebx
	...
	mov ebx, esi
	mov edi, esi
R_AssignSModelCacheResources_220:
	mov eax, [eax]
	mov [ebp-0x20d0], eax
	sub ebx, 0x4
	mov edx, eax
	jmp R_AssignSModelCacheResources_200
R_AssignSModelCacheResources_210:
	mov [edi], esi
	mov edi, ebx
	sub ebx, 0x4
	mov edx, [ebp-0x20d0]
R_AssignSModelCacheResources_200:
	mov esi, [ebx]
	mov [esp+0x4], esi
	mov [esp], edx
	call R_CompareSModels_Model
	test al, al
	jnz R_AssignSModelCacheResources_210
	mov ecx, [ebp-0x20d0]
	mov [edi], ecx
	...
	mov ebx, [ebp-0x20cc]
	mov edi, [ebp-0x20cc]
	jmp R_AssignSModelCacheResources_220
R_AssignSModelCacheResources_190:
	mov dword [esp+0x8], R_CompareSModels_Model
	mov esi, [ebp-0x20d4]
	mov [esp+0x4], esi
	mov eax, [ebp-0x20d8]
	mov [esp], eax
	call _ZSt16__insertion_sortIPPK22GfxStaticModelDrawInstPFhS2_S2_EEvT_S6_T0_
R_AssignSModelCacheResources_160:
	xor ebx, ebx
	mov dword [ebp-0x20ec], 0x0
	mov edx, [ebp+0x8]
	mov ecx, [edx+0x244]
R_AssignSModelCacheResources_340:
	cmp ebx, ecx
	jz R_AssignSModelCacheResources_230
R_AssignSModelCacheResources_280:
	mov eax, [ebp-0x20d8]
	lea eax, [eax+ebx*4]
	mov [ebp-0x207c], eax
	mov edx, eax
	...
	mov edi, ebx
	mov esi, eax
	jmp R_AssignSModelCacheResources_240
R_AssignSModelCacheResources_260:
	mov esi, [ebp-0x20dc]
R_AssignSModelCacheResources_240:
	mov eax, [edx]
	cmp [eax+0x38], esi
	jnz R_AssignSModelCacheResources_250
	add edi, 0x1
	add edx, 0x4
	cmp edi, ecx
	jnz R_AssignSModelCacheResources_260
R_AssignSModelCacheResources_250:
	mov eax, edi
	sub eax, ebx
	mov [ebp-0x20ac], eax
	cmp eax, 0xf
	ja R_AssignSModelCacheResources_270
	mov ebx, edi
R_AssignSModelCacheResources_310:
	cmp ebx, ecx
	jnz R_AssignSModelCacheResources_280
R_AssignSModelCacheResources_230:
	mov ecx, [ebp-0x20d8]
	mov [esp], ecx
	call Hunk_FreeTempMemory
	jmp R_AssignSModelCacheResources_290
R_AssignSModelCacheResources_270:
	mov edx, [ebp-0x20dc]
	mov [esp], edx
	...
	add eax, [ebp-0x20ec]
	cmp eax, 0x200
	jbe R_AssignSModelCacheResources_300
	mov ebx, [ebp+0x8]
	mov ecx, [ebx+0x244]
	mov ebx, edi
	jmp R_AssignSModelCacheResources_310
R_AssignSModelCacheResources_300:
	lea ecx, [ebp-0x2c]
	mov [esp+0x4], ecx
	lea esi, [ebp-0x24]
	mov [esp], esi
	call ClearBounds2D
	xor ebx, ebx
R_AssignSModelCacheResources_320:
	lea eax, [ebp-0x2c]
	mov [esp+0x8], eax
	mov [esp+0x4], esi
	mov edx, [ebp-0x207c]
	...
	add ebx, 0x1
	cmp [ebp-0x20ac], ebx
	jnz R_AssignSModelCacheResources_320
	mov eax, [ebp-0x20c8]
	test eax, eax
	jnz R_AssignSModelCacheResources_330
	mov esi, [ebp+0x8]
	mov ecx, [esi+0x244]
	mov ebx, edi
	jmp R_AssignSModelCacheResources_340
R_AssignSModelCacheResources_30:
	and eax, 0xffffff00
	jmp R_AssignSModelCacheResources_350
R_AssignSModelCacheResources_330:
	mov eax, [ebp-0x20ac]
	shr eax, 0x2
	mov [ebp-0x2064], eax
...
R_AssignSModelCacheResources_540:
	mov eax, [ebp-0x20c0]
	mov [esp+0x4], eax
	mov edx, [ebp-0x20dc]
	mov [esp], edx
	call XModelGetLodDist
	...
	mov esi, [ebp-0x20bc]
	test esi, esi
	jnz R_AssignSModelCacheResources_360
	xor edx, edx
	xor eax, eax
	cmp edx, eax
	cmovg eax, edx
	mov edx, eax
	add edx, 0x3
	js R_AssignSModelCacheResources_370
R_AssignSModelCacheResources_610:
	sar edx, 0x2
	lea eax, [edx-0x1]
	test eax, 0xffff0000
	jnz R_AssignSModelCacheResources_380
	mov ecx, 0x10
	mov esi, 0x10
R_AssignSModelCacheResources_580:
	mov edx, eax
	shl edx, cl
	test edx, 0xff000000
	jnz R_AssignSModelCacheResources_390
	mov ebx, 0x8
	mov eax, 0x8
R_AssignSModelCacheResources_570:
	lea esi, [eax+esi]
	mov ecx, ebx
	shl edx, cl
	test edx, 0xf0000000
	jnz R_AssignSModelCacheResources_400
	mov ebx, 0x4
	mov eax, 0x4
R_AssignSModelCacheResources_560:
	add esi, eax
	mov ecx, ebx
	shl edx, cl
	test edx, 0xc0000000
	jnz R_AssignSModelCacheResources_410
	mov ebx, 0x2
	mov eax, 0x2
R_AssignSModelCacheResources_550:
	lea eax, [esi+eax]
	mov ecx, ebx
	shl edx, cl
	mov ecx, edx
	...
	sub ecx, eax
	cmp ecx, 0x4
	jg R_AssignSModelCacheResources_420
	mov dword [ebp-0x2078], 0x4
R_AssignSModelCacheResources_520:
	...
	jg R_AssignSModelCacheResources_430
	mov dword [ebp-0x2074], 0x64
R_AssignSModelCacheResources_590:
	mov dword [ebp-0x20c4], 0x0
	mov dword [ebp-0x20a4], 0x0
	jmp R_AssignSModelCacheResources_440
R_AssignSModelCacheResources_460:
	add dword [ebp-0x20a4], 0x1
	mov ecx, [ebp-0x2074]
	cmp [ebp-0x20a4], ecx
	jae R_AssignSModelCacheResources_450
R_AssignSModelCacheResources_440:
	call randomf
	...
	movss [esp+0x4], xmm0
	fstp dword [esp]
	call PointInCircleFromUniformDeviates
	...
	mov esi, [ebp-0x20ac]
	sub esi, [ebp-0x20c4]
	jz R_AssignSModelCacheResources_460
	xor ebx, ebx
	mov dword [ebp-0x205c], 0x0
R_AssignSModelCacheResources_480:
	mov edx, [ebp-0x207c]
	mov eax, [edx+ebx*4]
	add eax, 0x4
	mov [esp+0x4], eax
	...
	jbe R_AssignSModelCacheResources_470
	...
	cmp esi, [ebp-0x20ac]
	adc esi, 0x0
R_AssignSModelCacheResources_470:
	add ebx, 0x1
	cmp esi, ebx
	ja R_AssignSModelCacheResources_480
	mov eax, [ebp-0x205c]
	cmp [ebp-0x20c4], eax
	jae R_AssignSModelCacheResources_460
	mov edx, [ebp-0x20ac]
	cmp eax, edx
	jz R_AssignSModelCacheResources_490
	mov [ebp-0x20c4], eax
	add dword [ebp-0x20a4], 0x1
	mov ecx, [ebp-0x2074]
	cmp [ebp-0x20a4], ecx
	jb R_AssignSModelCacheResources_440
R_AssignSModelCacheResources_450:
	mov ebx, [ebp-0x20c4]
	mov [ebp-0x205c], ebx
R_AssignSModelCacheResources_490:
	cmp dword [ebp-0x205c], 0xf
	jbe R_AssignSModelCacheResources_500
	mov eax, [ebp-0x20ec]
	shl eax, 0x4
	lea esi, [ebp-0x204c]
	lea eax, [esi+eax]
	...
	jmp R_AssignSModelCacheResources_500
R_AssignSModelCacheResources_170:
	and eax, 0xffffff00
	jmp R_AssignSModelCacheResources_510
R_AssignSModelCacheResources_420:
	mov [ebp-0x2078], ecx
	cmp ecx, 0x9
	jbe R_AssignSModelCacheResources_520
R_AssignSModelCacheResources_500:
	add dword [ebp-0x20c0], 0x1
	mov eax, [ebp-0x20c0]
	cmp [ebp-0x20c8], eax
	jbe R_AssignSModelCacheResources_530
	movss xmm0, dword [ebp-0x2060]
	movss [ebp-0x20b0], xmm0
	jmp R_AssignSModelCacheResources_540
R_AssignSModelCacheResources_410:
	xor ebx, ebx
	xor eax, eax
	jmp R_AssignSModelCacheResources_550
R_AssignSModelCacheResources_400:
	xor ebx, ebx
	xor eax, eax
	jmp R_AssignSModelCacheResources_560
R_AssignSModelCacheResources_390:
	xor ebx, ebx
	xor eax, eax
	jmp R_AssignSModelCacheResources_570
R_AssignSModelCacheResources_380:
	xor ecx, ecx
	xor esi, esi
	jmp R_AssignSModelCacheResources_580
R_AssignSModelCacheResources_430:
	mov eax, [ebp-0x2064]
	mov [ebp-0x2074], eax
	test eax, eax
	jz R_AssignSModelCacheResources_500
	jmp R_AssignSModelCacheResources_590
R_AssignSModelCacheResources_360:
	xor esi, esi
	mov dword [ebp-0x20b4], 0x0
	mov dword [ebp-0x20b8], 0x0
	xor ebx, ebx
R_AssignSModelCacheResources_600:
	mov eax, ebx
	add eax, [ebp-0x1c]
	mov [esp], eax
	...
	add ebx, 0x38
	cmp [ebp-0x20bc], esi
	jnz R_AssignSModelCacheResources_600
	mov ecx, [ebp-0x20b4]
	lea edx, [ecx+ecx*2]
	mov eax, [ebp-0x20b8]
	shl eax, 0x2
	...
	mov edx, eax
	add edx, 0x3
	jns R_AssignSModelCacheResources_610
R_AssignSModelCacheResources_370:
	lea edx, [eax+0x6]
	jmp R_AssignSModelCacheResources_610
R_AssignSModelCacheResources_140:
	xor eax, eax
	jmp R_AssignSModelCacheResources_620
R_AssignSModelCacheResources_530:
	mov edx, [ebp+0x8]
	mov ecx, [edx+0x244]
	mov ebx, edi
	jmp R_AssignSModelCacheResources_340
