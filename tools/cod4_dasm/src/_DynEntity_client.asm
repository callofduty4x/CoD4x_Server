...
DynEntCl_LinkModel:
	...
	mov [ebp-0x1b8], eax
	mov [ebp-0x108], eax
	movss xmm3, dword [g_zero_dup_1+0x4]
	xor ebx, ebx
	ucomiss xmm3, [ebp-0x1c0]
	setbe bl
	sub ebx, 0x1
	mov [ebp-0x104], ebx
	movss xmm2, dword [g_zero_dup_1+0x8]
	xor ecx, ecx
	ucomiss xmm2, [ebp-0x1c4]
	setbe cl
	sub ecx, 0x1
	mov [ebp-0x100], ecx
	movss xmm0, dword [g_zero_dup_1+0xc]
	ucomiss xmm0, xmm1
...
DynEntCl_LinkBrush:
	...
	mov [ebp-0x198], eax
	mov [ebp-0x100], eax
	movss xmm0, dword [g_zero_dup_1+0x4]
	xor ebx, ebx
...
g_zero_dup_1: dd 0x0, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x7fffffff, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0
