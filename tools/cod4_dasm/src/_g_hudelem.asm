...
GScr_NewHudElem:
	...
	xor eax, eax
	mov edx, g_hudelems
	jmp GScr_NewHudElem_10
GScr_NewHudElem_30:
	add eax, 0x1
	add edx, 0xac
	cmp eax, 0x400
	jz GScr_NewHudElem_20
GScr_NewHudElem_10:
	mov ecx, [edx]
	test ecx, ecx
	jnz GScr_NewHudElem_30
	lea edx, [eax+eax*4]
	lea edx, [eax+edx*4]
	lea edx, [eax+edx*2]
	shl edx, 0x2
...
GScr_NewClientHudElem:
	...
	mov eax, [eax+0x15c]
	test eax, eax
	jz GScr_NewClientHudElem_10
GScr_NewClientHudElem_50:
	mov ebx, [ebx]
	xor eax, eax
	mov edx, g_hudelems
	jmp GScr_NewClientHudElem_20
GScr_NewClientHudElem_40:
	add eax, 0x1
	add edx, 0xac
	cmp eax, 0x400
	jz GScr_NewClientHudElem_30
GScr_NewClientHudElem_20:
	mov ecx, [edx]
	test ecx, ecx
	jnz GScr_NewClientHudElem_40
	lea edx, [eax+eax*4]
	lea edx, [eax+edx*4]
	lea edx, [eax+edx*2]
	shl edx, 0x2
...
GScr_NewClientHudElem_60:
	...
	pop ebp
	ret
GScr_NewClientHudElem_10:
	mov dword [esp+0x4], _cstring_not_a_client
	mov dword [esp], 0x0
	call Scr_ParamError
	jmp GScr_NewClientHudElem_50
GScr_NewClientHudElem_30:
	mov dword [esp], _cstring_out_of_hudelems
	call Scr_Error
	xor ecx, ecx
	jmp GScr_NewClientHudElem_60
	nop
