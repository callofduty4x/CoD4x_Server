;Imports of fx_profile:

;Exports of fx_profile:
	global _GLOBAL__I__Z14FX_DrawProfileiPFvPKcPfES1_


SECTION .text


;global constructors keyed to FX_DrawProfile(int, void (*)(char const*, float*), float*)
_GLOBAL__I__Z14FX_DrawProfileiPFvPKcPfES1_:
	push ebp
	mov ebp, esp
	mov edx, 0xffff
	mov eax, 0x1
...
;Initialized global or static variables of fx_profile:
SECTION .data


;Initialized constant data of fx_profile:
SECTION .rdata
...
;Zero initialized global or static variables of fx_profile:
SECTION .bss
g_keepZ: resb 0x10
g_keepX: resb 0x10
g_keepZW: resb 0x10
