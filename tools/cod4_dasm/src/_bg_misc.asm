...
BG_RegisterDvars_10:
	...
	call Jump_RegisterDvars
	call Mantle_RegisterDvars
	add esp, 0x2c
	pop ebx
	pop esi
	pop edi
	pop ebp
	jmp Perks_RegisterDvars
...
BG_CheckProneValid_10:
	movss xmm0, dword [ebp+0x10]
	xorps xmm0, [singleClientEvents+0x60]
	movss [ebp-0x24], xmm0
	movss [ebp-0x20], xmm0
