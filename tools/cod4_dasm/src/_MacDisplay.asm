...
;Exports of MacDisplay:
	...
	global __tcf_2
	global __tcf_3
	global UserPaneDrawProc
	global UserPaneTrackingProc
...
CenterWindowOnDisplay:
	...
	jnz CenterWindowOnDisplay_10
CenterWindowOnDisplay_20:
	mov eax, [ebx]
	mov edx, [eax+0x26]
	mov eax, [eax+0x22]
	mov [ebp-0x10], eax
	mov [ebp-0xc], edx
CenterWindowOnDisplay_30:
	lea eax, [ebp-0x18]
	mov [esp+0x4], eax
	mov eax, [sMainWindow]
	mov [esp], eax
...
PseudoAGLSetFullscreen:
	...
	mov ecx, [ebp-0x20]
	test ecx, ecx
	jz PseudoAGLSetFullscreen_10
	test eax, eax
	jz PseudoAGLSetFullscreen_10
PseudoAGLSetFullscreen_110:
	mov eax, [sPreviousDisplayMode]
	test eax, eax
	jz PseudoAGLSetFullscreen_20
PseudoAGLSetFullscreen_150:
	...
	mov eax, [ebp-0x24]
	test eax, eax
	jz PseudoAGLSetFullscreen_30
	mov [esp], esi
	call CGDisplayCapture
PseudoAGLSetFullscreen_120:
	mov [esp+0x4], ebx
	mov [esp], esi
	call CGDisplaySwitchToMode
	test eax, eax
	jz PseudoAGLSetFullscreen_40
	mov eax, [ebp+0x8]
	test eax, eax
	jnz PseudoAGLSetFullscreen_50
PseudoAGLSetFullscreen_40:
	mov eax, [sFullscreenPort]
	test eax, eax
	jz PseudoAGLSetFullscreen_60
	mov eax, [ebp-0x34]
	mov [esp], eax
	call aglGetDrawable
	cmp eax, [sFullscreenPort]
	jz PseudoAGLSetFullscreen_70
PseudoAGLSetFullscreen_170:
	mov dword [esp], 0x0
	call SetPort
	mov eax, [sFullscreenPort]
	mov [esp], eax
	call DisposePort
PseudoAGLSetFullscreen_60:
	lea eax, [ebp-0x28]
	mov [esp], eax
	call GetPort
	mov [esp], esi
	...
	test dx, dx
	jnz PseudoAGLSetFullscreen_80
	cmp word [eax+0x6], 0x0
	jnz PseudoAGLSetFullscreen_80
PseudoAGLSetFullscreen_90:
	mov eax, [ebp-0x28]
	mov [esp], eax
	call SetPort
...
PseudoAGLSetFullscreen_140:
	...
	pop ebp
	ret
PseudoAGLSetFullscreen_80:
	movsx eax, word [eax+0x6]
	mov [esp+0x4], eax
	movsx eax, dx
	mov [esp], eax
	call SetOrigin
	jmp PseudoAGLSetFullscreen_90
PseudoAGLSetFullscreen_10:
	mov edx, [ebp+0x8]
	test edx, edx
	jnz PseudoAGLSetFullscreen_100
PseudoAGLSetFullscreen_130:
	lea eax, [ebp-0x20]
	mov [esp+0x10], eax
	mov [esp+0xc], edi
	mov eax, [ebp-0x38]
	...
	mov ebx, eax
	jmp PseudoAGLSetFullscreen_110
PseudoAGLSetFullscreen_30:
	call CGCaptureAllDisplays
	jmp PseudoAGLSetFullscreen_120
PseudoAGLSetFullscreen_100:
	lea eax, [ebp-0x20]
	mov [esp+0x18], eax
	...
	mov ebx, eax
	test eax, eax
	jnz PseudoAGLSetFullscreen_110
	jmp PseudoAGLSetFullscreen_130
PseudoAGLSetFullscreen_50:
	lea eax, [ebp-0x20]
	mov [esp+0x10], eax
	mov [esp+0xc], edi
	mov eax, [ebp-0x38]
	...
	xor eax, eax
	jmp PseudoAGLSetFullscreen_140
PseudoAGLSetFullscreen_20:
	mov [esp], esi
	call CGDisplayCurrentMode
	mov [sPreviousDisplayMode], eax
	jmp PseudoAGLSetFullscreen_150
PseudoAGLSetFullscreen_70:
	call aglGetCurrentContext
	cmp [ebp-0x34], eax
	jz PseudoAGLSetFullscreen_160
PseudoAGLSetFullscreen_180:
	mov dword [esp+0x4], 0x0
	mov eax, [ebp-0x34]
	mov [esp], eax
	call aglSetDrawable
	jmp PseudoAGLSetFullscreen_170
PseudoAGLSetFullscreen_160:
	call glFinish
	jmp PseudoAGLSetFullscreen_180
	nop
...
UserPaneDrawProc:
	...
	sar eax, 0x3
	test eax, eax
	jz UserPaneDrawProc_10
UserPaneDrawProc_140:
	...
	jz UserPaneDrawProc_20
	mov eax, edx
	lea edi, [ebp-0x56]
	jmp UserPaneDrawProc_30
UserPaneDrawProc_50:
	mov dword [esp], 0x21
	call ForeColor
	mov [esp], edi
...
UserPaneDrawProc_10:
	...
	jz UserPaneDrawProc_100
	mov [ebp-0x12c], eax
	jmp UserPaneDrawProc_110
UserPaneDrawProc_120:
	mov [ebp-0x140], ebx
	mov [ebp-0x13c], esi
	mov [ebp-0x138], edi
...
UserPaneDrawProc_110:
	...
	mov eax, [ebp-0x12c]
	cmp [sDisplayList+0x4], eax
	jnz UserPaneDrawProc_110
UserPaneDrawProc_100:
	movss xmm0, dword [ebp-0x140]
	movss [ebp-0xa4], xmm0
	movss xmm2, dword [ebp-0x13c]
	movss [ebp-0xa8], xmm2
...
UserPaneDrawProc_190:
	...
	mov eax, [sDisplayList]
	cmp eax, [sDisplayList+0x4]
	jz UserPaneDrawProc_140
	mov ebx, eax
	lea esi, [ebp-0x4e]
	lea edi, [ebp-0x56]
	jmp UserPaneDrawProc_150
UserPaneDrawProc_180:
	add ebx, 0x68
	cmp ebx, [sDisplayList+0x4]
	jz UserPaneDrawProc_140
	mov eax, ebx
UserPaneDrawProc_150:
...
UserPaneTrackingProc:
	...
	xor ebx, ebx
	lea esi, [ebp-0x20]
	jmp UserPaneTrackingProc_10
UserPaneTrackingProc_30:
	mov eax, [edx+ebx*8]
	...
	call PtInRect
	test al, al
	jnz UserPaneTrackingProc_20
	add ebx, 0x1
UserPaneTrackingProc_10:
	mov edx, [sRectList]
	mov eax, [sRectList+0x4]
	sub eax, edx
	sar eax, 0x3
	cmp eax, ebx
	ja UserPaneTrackingProc_30
UserPaneTrackingProc_40:
	xor eax, eax
	add esp, 0x2c
	pop ebx
	pop esi
	...
	pop ebp
	ret
UserPaneTrackingProc_20:
	cmp ebx, [sDisplayIndex]
	jz UserPaneTrackingProc_40
	mov [sDisplayIndex], ebx
	mov dword [esp+0x4], 0x0
	mov eax, [ebp+0x8]
	mov [esp], eax
	call UserPaneDrawProc
	xor eax, eax
	add esp, 0x2c
	pop ebx
	pop esi
...
_ZN10MacDisplay10InitializeEv_320:
	...
	mov dword [esp+0xc], UserPaneTrackingProc
	mov dword [esp+0x8], UserPaneDrawProc
	mov dword [esp+0x4], 0x1
	mov [esp], eax
