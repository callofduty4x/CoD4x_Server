...
;Exports of stringed_hooks:
	...
	global SEH_InitLanguage
	global SEH_Init_StringEd
	global SEH_GetLanguageName
	global SEH_Shutdown_StringEd
	global SEH_GetCurrentLanguage
	...
	global SEH_GetLanguageIndexForName
...
SEH_GetLanguageName:
	...
	mov eax, [ebp+0x8]
	cmp eax, 0xe
	jbe SEH_GetLanguageName_10
	mov eax, [g_languages]
	pop ebp
	ret
SEH_GetLanguageName_10:
...
SEH_GetLanguageIndexForName:
	...
	xor esi, esi
	mov ebx, g_languages
SEH_GetLanguageIndexForName_20:
	mov eax, [ebx]
	mov [esp+0x4], eax
	mov [esp], edi
	call Q_stricmp
	test eax, eax
	jz SEH_GetLanguageIndexForName_10
	add esi, 0x1
	add ebx, 0x8
	cmp esi, 0xf
	jnz SEH_GetLanguageIndexForName_20
	mov eax, [ebp+0xc]
	mov dword [eax], 0x0
	xor eax, eax
	add esp, 0x1c
	...
	pop ebp
	ret
SEH_GetLanguageIndexForName_10:
	mov eax, [ebp+0xc]
	mov [eax], esi
	mov eax, 0x1
	add esp, 0x1c
