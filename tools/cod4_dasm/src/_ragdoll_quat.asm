...
;Exports of ragdoll_quat:
	global Ragdoll_QuatMul
	global Ragdoll_QuatLerp
	global Ragdoll_Mat33ToQuat
	global Ragdoll_QuatNormalize
	global Ragdoll_QuatPointRotate
	global Ragdoll_QuatToAxisAngle
	global Ragdoll_QuatMulInvSecond
...
Ragdoll_Mat33ToQuat:
	...
	ja Ragdoll_Mat33ToQuat_10
	ucomiss xmm4, xmm1
	ja Ragdoll_Mat33ToQuat_20
Ragdoll_Mat33ToQuat_40:
	ucomiss xmm1, xmm3
	ja Ragdoll_Mat33ToQuat_30
	addss xmm3, xmm5
	subss xmm3, xmm4
	subss xmm3, xmm1
	sqrtss xmm1, xmm3
	...
	pop ebp
	ret
Ragdoll_Mat33ToQuat_20:
	ucomiss xmm4, xmm3
	jbe Ragdoll_Mat33ToQuat_40
	addss xmm4, xmm5
	subss xmm4, xmm1
	subss xmm4, xmm3
	sqrtss xmm1, xmm4
