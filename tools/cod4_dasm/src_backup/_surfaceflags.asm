...
;Exports of surfaceflags:
	global _Z21Com_SurfaceTypeToNamei
	global _Z23Com_SurfaceTypeFromNamePKc
	global infoParms
...
_Z21Com_SurfaceTypeToNamei:
	push ebp
	mov ebp, esp
	mov eax, [ebp+0x8]
	sub eax, 0x1
	cmp eax, 0x1b
	ja _Z21Com_SurfaceTypeToNamei_10
	lea eax, [eax+eax*4]
	mov eax, [eax*4+infoParms]
	pop ebp
	ret
_Z21Com_SurfaceTypeToNamei_10:
...
_Z23Com_SurfaceTypeFromNamePKc:
	push ebp
	mov ebp, esp
	push edi
	push esi
	...
	test eax, eax
	jnz _Z23Com_SurfaceTypeFromNamePKc_10
	add esp, 0x1c
	pop ebx
	pop esi
	pop edi
	pop ebp
	ret
_Z23Com_SurfaceTypeFromNamePKc_10:
	xor esi, esi
	mov ebx, infoParms
	jmp _Z23Com_SurfaceTypeFromNamePKc_20
_Z23Com_SurfaceTypeFromNamePKc_40:
	add esi, 0x1
	add ebx, 0x14
	cmp esi, 0x1c
	jz _Z23Com_SurfaceTypeFromNamePKc_30
_Z23Com_SurfaceTypeFromNamePKc_20:
	mov eax, [ebx]
	mov [esp+0x4], eax
	mov [esp], edi
	call _Z9I_stricmpPKcS0_
	test eax, eax
	jnz _Z23Com_SurfaceTypeFromNamePKc_40
	lea eax, [esi+esi*4]
	...
	pop ebp
	ret
_Z23Com_SurfaceTypeFromNamePKc_30:
	mov eax, 0xffffffff
	add esp, 0x1c
	pop ebx
	pop esi
