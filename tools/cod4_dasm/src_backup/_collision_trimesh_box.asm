...
;Exports of collision_trimesh_box:
	global _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf
...
_Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf:
	push ebp
	mov ebp, esp
	push edi
	push esi
	...
	mov ecx, [ebp-0x18]
	test ecx, ecx
	jle _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_10
	mov dword [ebp-0x10], 0x0
	pxor xmm7, xmm7
	mov ebx, edx
	jmp _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_20
_Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_60:
	mov [ebp-0x10], edx
_Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_20:
	...
	addss xmm4, xmm3
	ucomiss xmm5, xmm7
	jb _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_30
	mov eax, [esi]
	shl eax, 0x4
	mov edx, [ebp+0x8]
	movss [eax+edx], xmm6
	...
	mov [esi], eax
	ucomiss xmm5, xmm7
	jbe _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_30
	ucomiss xmm7, xmm4
	ja _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_40
_Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_30:
	ucomiss xmm7, xmm5
	jbe _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_50
	ucomiss xmm4, xmm7
	jbe _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_50
	mov eax, [esi]
_Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_40:
	...
	add dword [esi], 0x1
_Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_50:
	mov edx, [ebp-0x10]
	add edx, 0x1
	add ebx, 0x10
	mov eax, [ebp-0x10]
	cmp [ebp-0x18], edx
	jnz _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_60
_Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf_10:
	add esp, 0xc
	pop ebx
	pop esi
	pop edi
...
dCollideBoxTriangleList_620:
	...
	lea edx, [ebp-0x160]
	lea eax, [ebp-0x344]
	call _Z19_cldClipPolyToPlaneP10collData_tPA4_fiS2_RiRA4_Kf
