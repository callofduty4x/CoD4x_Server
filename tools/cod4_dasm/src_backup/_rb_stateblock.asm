;Imports of rb_stateblock:

;Exports of rb_stateblock:
	global _GLOBAL__I_marker_rb_stateblock


SECTION .text


;global constructors keyed to marker_rb_stateblock
_GLOBAL__I_marker_rb_stateblock:
	push ebp
	mov ebp, esp
	mov edx, 0xffff
	mov eax, 0x1
...
;Initialized global or static variables of rb_stateblock:
SECTION .data


;Initialized constant data of rb_stateblock:
SECTION .rdata
...
;Zero initialized global or static variables of rb_stateblock:
SECTION .bss
g_keepZ: resb 0x10
g_keepX: resb 0x10
g_keepZW: resb 0x10
