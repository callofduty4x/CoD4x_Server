...
gcc -m32 -Wall -O0 -g -fno-omit-frame-pointer -march=nocona -D COD4X18UPDATE -D WINVER=0x501 -I..\lib_tomcrypt\headers -I..\lib_tomcrypt\math\tommath -c ..\src\*.c
gcc -m32 -Wall -O0 -g -fno-omit-frame-pointer -mtune=nocona -D WINVER=0x501 -c ..\src\zlib\*.c
gcc -m32 -Wall -O0 -g -fno-omit-frame-pointer -mtune=nocona -D WINVER=0x501 -c ..\src\xassets\*.c
cd ..\
...
echo Linking...
gcc -m32 -g -Wl,--nxcompat,--image-base,0x8040000,--stack,0x800000  -Tlinkerscript_win32.ld -o bin\cod4x18_dedrun bin\*.o src\win32\win_cod4.res -Llib\ -ltomcrypt_win32 -lmbedtls_win32 -lm -lws2_32 -lwsock32 -lgdi32 -liphlpapi -mwindows -lwinmm -static-libgcc -static -lstdc++
