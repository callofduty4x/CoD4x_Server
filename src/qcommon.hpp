...
void CCDECL Com_InitParse( void );
void CCDECL Com_Restart(void);
void CCDECL Com_WriteConfig_f(void);
void CCDECL Com_WriteDefaults_f(void);
void CCDECL Com_Close(void);
int CCDECL Com_Filter(const char* filter, char *name, int casesensitive);
...
void CCDECL Com_SafeServerDObjFree(int handle);
