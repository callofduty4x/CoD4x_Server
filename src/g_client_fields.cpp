...
struct client_fields_s
{
  ...
  int ofs;
  fieldtype_t type;
  void (CCDECL *setter)(gclient_s *, struct client_fields_s *);
  void (CCDECL *getter)(gclient_s *, struct client_fields_s *);
};

void CCDECL ClientScr_ReadOnly(gclient_s *pSelf, client_fields_s *pField)
{
  assert( pSelf );
  assert( pField );
...
void CCDECL ClientScr_GetSessionTeam(gclient_s *pSelf, client_fields_s *pField)
{
  assert( pSelf );
...
void CCDECL ClientScr_SetSessionTeam(gclient_s *pSelf, client_fields_s *pField)
{
  uint16_t newTeam;
...
void CCDECL ClientScr_SetArchiveTime(gclient_s *pSelf, client_fields_s *pField)
{
    assert( pSelf );
...
void CCDECL ClientScr_GetArchiveTime(gclient_s *pSelf, client_fields_s *pField)
{
  Scr_AddFloat((float)pSelf->sess.archiveTime * 0.001);
}

void CCDECL ClientScr_SetMaxHealth(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf);
...
void CCDECL ClientScr_SetHeadIconTeam(gclient_s *pSelf, client_fields_s *pField)
{
  gentity_s *pEnt;
  uint16_t sTeam;
...
void CCDECL ClientScr_GetHeadIconTeam(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
  assert( (unsigned int)(pSelf - level.clients) < (unsigned int)level.maxclients);
...
void CCDECL ClientScr_SetScore(gclient_s *pSelf, client_fields_s *pField)
{
  int score;
...
void CCDECL ClientScr_SetKillCamEntity(gclient_s *pSelf, client_fields_s *pField)
{
...
void CCDECL ClientScr_SetSessionState(gclient_s *pSelf, client_fields_s *pField)
{
  uint16_t newState;
  assert(pSelf != NULL);
...
void CCDECL ClientScr_GetSessionState(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
  assert(pSelf->sess.connected != CON_DISCONNECTED);
...
void CCDECL ClientScr_GetStatusIcon(gclient_s *pSelf, client_fields_s *pField)
{
...
void CCDECL ClientScr_SetStatusIcon(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
...
void CCDECL ClientScr_SetSpectatorClient(gclient_s *pSelf, client_fields_s *pField)
{
...
void CCDECL ClientScr_GetSpectatorClient(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
...
void CCDECL ClientScr_SetPSOffsetTime(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
...
void CCDECL ClientScr_GetPSOffsetTime(gclient_s *pSelf, client_fields_s *pField)
{
  Scr_AddInt(pSelf->sess.archiveTime);
}

void CCDECL ClientScr_SetHeadIcon(gclient_s *pSelf, client_fields_s *pField)
{
  gentity_s *pEnt;
  const char *pszIcon; 
...
void CCDECL ClientScr_GetHeadIcon(gclient_s *pSelf, client_fields_s *pField)
{
  char szConfigString[1024];
  gentity_s *pEnt;
...
void CCDECL ClientScr_GetEntityFromIndex(gclient_s *pSelf, client_fields_s *pField)
{
  int entNum;
  gentity_t* ent;
...
void CCDECL ClientScr_GetName(gclient_s *pSelf, client_fields_s *pField)
{
  assert(pSelf != NULL);
...
void CCDECL ClientScr_GetBotStatus(gclient_s *pSelf, client_fields_s *pField)
{
	assert(pSelf != NULL);
...
void CCDECL ClientScr_SetBotStatus(gclient_s *pSelf, client_fields_s *pField)
{
}
...
void CCDECL GScr_AddFieldsForClient()
{
  client_fields_s *f;
...
void CCDECL Scr_GetClientField(gclient_s *client, int offset)
{
  client_fields_s *f;
...
void CCDECL Scr_SetClientField(gclient_s *client, int offset)
{
  client_fields_s *f;
