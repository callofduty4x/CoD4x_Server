...
=============
*/
void CCDECL XACHLP_Printf( const char *fmt, ... ) {
	va_list		argptr;
...
=============
*/
void CCDECL XACHLP_PrintWarning( const char *fmt, ... ) {
	va_list		argptr;
	char		msg[MAXPRINTMSG];
...
=============
*/
void CCDECL XACHLP_PrintError( const char *fmt, ... ) {
	va_list		argptr;
	char		msg[MAXPRINTMSG];
...
================
*/
void CCDECL XACHLP_DPrintf( const char *fmt, ...) {
	va_list		argptr;
	char		msg[MAXPRINTMSG];
