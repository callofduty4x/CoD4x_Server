...
{
  void (CCDECL *think)(struct gentity_s *);
  void (CCDECL *reached)(struct gentity_s *);
  void (CCDECL *blocked)(struct gentity_s *, struct gentity_s *);
  void (CCDECL *touch)(struct gentity_s *, struct gentity_s *, int);
  void (CCDECL *use)(struct gentity_s *, struct gentity_s *, struct gentity_s *);
  void (CCDECL *pain)(struct gentity_s *, struct gentity_s *, int, const float *, const int, const float *, enum hitLocation_t, const int);
  void (CCDECL *die)(struct gentity_s *, struct gentity_s *, struct gentity_s *, int, int, const int, const float *, enum hitLocation_t, int);
  void (CCDECL *controller)(struct gentity_s *, int *);
  int methodOfDeath;
...
const char *CCDECL G_GetEntityParsePoint();
void CCDECL G_SetEntityParsePoint(const char *beginParsePoint);
qboolean CCDECL G_ParseSpawnVars(SpawnVar *spawnVar);
...
void CCDECL G_PrintEntities();
void CCDECL TeleportPlayer(struct gentity_s *player, float *origin, float *angles);
void CCDECL Cmd_Give_f(struct gentity_s *ent);
void CCDECL Cmd_Take_f(struct gentity_s *ent);
const char *CCDECL G_GetEntityTypeName(gentity_t *ent);
int CCDECL G_ClientCanSpectateTeam(gclient_t *client, team_t team);
int CCDECL G_ClientCanSpectateTeamOrLocalPlayer(gclient_t *client, clientState_t *cs);
void CCDECL G_GetPlayerViewOrigin(playerState_t *ps, float *origin);
void CCDECL BG_GetPlayerViewDirection(playerState_t *ps, float *forward, float *right, float *up);
void CCDECL G_SetOrigin(gentity_t *ent, const float *origin);
void CCDECL SetClientViewAngle(gentity_t *ent, const float *angle);
qboolean GetFollowPlayerState(int clientNum, playerState_t *ps);
void CalculateRanks();
int CCDECL GScr_GetStatusIconIndex(const char *pszIcon);
int CCDECL GScr_GetHeadIconIndex(const char *pszIcon);
unsigned int CCDECL G_ModelName(int index);
void CCDECL Com_SetWeaponInfoMemory(int source);
void CCDECL ClearRegisteredItems();
void CCDECL BG_ClearWeaponDef();
int CCDECL G_GetWeaponIndexForName(const char *name);
void CCDECL G_EntUnlink(struct gentity_s *ent);
void CCDECL G_SetClientContents(struct gentity_s *pEnt);
void CCDECL ClientEndFrame(struct gentity_s *ent);
void CCDECL ClientThink_real(struct gentity_s *ent, struct usercmd_s *ucmd);
void CCDECL BG_PlayerStateToEntityState(struct playerState_s *ps, struct entityState_s *s, int snap, char handler);
...
void CCDECL G_RunMover(struct gentity_s *gEnt);
void CCDECL G_RunClient(gentity_t *gEnt);
void CCDECL G_RunCorpse(gentity_t *gEnt);
void CCDECL Scr_FreeEntity(struct gentity_s *ent);
void CCDECL PlayerCorpse_Free(struct gentity_s *ent);
void CCDECL G_VehFreeEntity(struct gentity_s *ent);
void CCDECL G_FreeTurret(struct gentity_s *ent);
void CCDECL G_FreeEntityRefs(struct gentity_s *ent);
void CCDECL XAnimClearTree(struct XAnimTree_s *tree);
void CCDECL G_LocationalTrace(trace_t *results, const float *start, const float *end, int passEntityNum, int contentmask, char *priorityMap);


void CCDECL Touch_Multi(struct gentity_s *, struct gentity_s *, int);
void CCDECL hurt_use(struct gentity_s *, struct gentity_s *, struct gentity_s *);
void CCDECL hurt_touch(struct gentity_s *, struct gentity_s *, int);
void CCDECL Use_trigger_damage(struct gentity_s *, struct gentity_s *, struct gentity_s *);
void CCDECL Reached_ScriptMover(struct gentity_s *);
void CCDECL Pain_trigger_damage(struct gentity_s *, struct gentity_s *, int, const float *, const int, const float *, enum hitLocation_t, const int);
void CCDECL Die_trigger_damage(struct gentity_s *, struct gentity_s *, struct gentity_s *, int, int, const int, const float *, enum hitLocation_t, int);
void CCDECL Touch_Item_Auto(struct gentity_s *, struct gentity_s *, int);
void CCDECL G_TimedObjectThink(struct gentity_s *);
void CCDECL G_PlayerController(struct gentity_s *, int *);
void CCDECL turret_use(struct gentity_s *, struct gentity_s *, struct gentity_s *);
void CCDECL turret_controller(struct gentity_s *, int *);
void CCDECL turret_think(struct gentity_s *);
void CCDECL G_VehEntHandler_Think(struct gentity_s *);
void CCDECL G_VehEntHandler_Touch(struct gentity_s *, struct gentity_s *, int);
void CCDECL G_VehEntHandler_Use(struct gentity_s *, struct gentity_s *, struct gentity_s *);
void CCDECL G_VehEntHandler_Pain(struct gentity_s *, struct gentity_s *, int, const float *, const int, const float *, enum hitLocation_t, const int);
void CCDECL G_VehEntHandler_Die(struct gentity_s *, struct gentity_s *, struct gentity_s *, int, int, const int, const float *, enum hitLocation_t, int);
void CCDECL G_VehEntHandler_Controller(struct gentity_s *, int *);
void CCDECL Helicopter_Think(struct gentity_s *);
void CCDECL Helicopter_Pain(struct gentity_s *, struct gentity_s *, int, const float *, const int, const float *, enum hitLocation_t, const int);
void CCDECL Helicopter_Die(struct gentity_s *, struct gentity_s *, struct gentity_s *, int, int, const int, const float *, enum hitLocation_t, int);
void CCDECL Helicopter_Controller(struct gentity_s *, int *);
void CCDECL G_ExplodeMissile(struct gentity_s *);
void CCDECL BodyEnd(struct gentity_s *);
void CCDECL turret_think_init(struct gentity_s *);
void CCDECL DroppedItemClearOwner(struct gentity_s *);
void CCDECL FinishSpawningItem(struct gentity_s *);
void CCDECL use_trigger_use(struct gentity_s *, struct gentity_s *, struct gentity_s *);
