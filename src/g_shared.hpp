...
struct entityHandler_t
{
  ...
  void (CDECL *reached)(struct gentity_s *);
  void (CDECL *blocked)(struct gentity_s *, struct gentity_s *);
  void (CDECL *touch)(struct gentity_s *, struct gentity_s *, int);
  void (CDECL *use)(struct gentity_s *, struct gentity_s *, struct gentity_s *);
  void (CDECL *pain)(struct gentity_s *, struct gentity_s *, int, const float *, const int, const float *, enum hitLocation_t, const int);
  void (CDECL *die)(struct gentity_s *, struct gentity_s *, struct gentity_s *, int, int, const int, const float *, enum hitLocation_t, int);
  void (CDECL *controller)(struct gentity_s *, int *);
  int methodOfDeath;
...
const char *CDECL G_GetEntityParsePoint();
void CDECL G_SetEntityParsePoint(const char *beginParsePoint);
qboolean CDECL G_ParseSpawnVars(SpawnVar *spawnVar);
...
void CDECL G_SetModel(gentity_t *ent, const char *modelname);
/* void ClientSetUsername(int clientNum, const char *username); */
void CDECL G_DObjCalcPose(gentity_t *ent, int *partBits);
void CDECL player_die(struct gentity_s *self, struct gentity_s *inflictor, struct gentity_s *attacker, int damage, int meansOfDeath, int iWeapon, const float *vDir, enum hitLocation_t hitLoc, int psTimeOffset);
void SendScoreboard(struct gentity_s*);
void CDECL G_PrintEntities();
void CDECL TeleportPlayer(struct gentity_s *player, float *origin, float *angles);
void CDECL Cmd_Give_f(struct gentity_s *ent);
void CDECL Cmd_Take_f(struct gentity_s *ent);
const char *CDECL G_GetEntityTypeName(gentity_t *ent);
int CDECL G_ClientCanSpectateTeam(gclient_t *client, team_t team);
int CDECL G_ClientCanSpectateTeamOrLocalPlayer(gclient_t *client, clientState_t *cs);
void CDECL G_GetPlayerViewOrigin(playerState_t *ps, float *origin);
void CDECL BG_GetPlayerViewDirection(playerState_t *ps, float *forward, float *right, float *up);
void CDECL G_SetOrigin(gentity_t *ent, const float *origin);
void CDECL SetClientViewAngle(gentity_t *ent, const float *angle);
...
unsigned int CDECL G_ModelName(int index);
void CDECL Com_SetWeaponInfoMemory(int source);
void CDECL ClearRegisteredItems();
void CDECL BG_ClearWeaponDef();
int CDECL G_GetWeaponIndexForName(const char *name);
void CDECL G_EntUnlink(struct gentity_s *ent);
void CDECL G_SetClientContents(struct gentity_s *pEnt);
void CDECL ClientEndFrame(struct gentity_s *ent);
void CDECL ClientThink_real(struct gentity_s *ent, struct usercmd_s *ucmd);
void CDECL BG_PlayerStateToEntityState(struct playerState_s *ps, struct entityState_s *s, int snap, char handler);
...
uint16_t CDECL G_GetHitLocationString(enum hitLocation_t hitLoc);
void CDECL G_FreeEntity(struct gentity_s *gEnt);
void CDECL G_RunMissile(gentity_t *gEnt);
void CDECL G_GeneralLink(struct gentity_s *gEnt);
void CDECL G_RunItem(gentity_t *gEnt);
void CDECL G_RunMover(struct gentity_s *gEnt);
void CDECL G_RunClient(gentity_t *gEnt);
void CDECL G_RunCorpse(gentity_t *gEnt);
void CDECL Scr_FreeEntity(struct gentity_s *ent);
void CDECL PlayerCorpse_Free(struct gentity_s *ent);
void CDECL G_VehFreeEntity(struct gentity_s *ent);
void CDECL G_FreeTurret(struct gentity_s *ent);
void CDECL G_FreeEntityRefs(struct gentity_s *ent);
void CDECL XAnimClearTree(struct XAnimTree_s *tree);
void CDECL G_LocationalTrace(trace_t *results, const float *start, const float *end, int passEntityNum, int contentmask, char *priorityMap);


void CDECL Touch_Multi(struct gentity_s *, struct gentity_s *, int);
void CDECL hurt_use(struct gentity_s *, struct gentity_s *, struct gentity_s *);
void CDECL hurt_touch(struct gentity_s *, struct gentity_s *, int);
void CDECL Use_trigger_damage(struct gentity_s *, struct gentity_s *, struct gentity_s *);
void CDECL Reached_ScriptMover(struct gentity_s *);
void CDECL Pain_trigger_damage(struct gentity_s *, struct gentity_s *, int, const float *, const int, const float *, enum hitLocation_t, const int);
void CDECL Die_trigger_damage(struct gentity_s *, struct gentity_s *, struct gentity_s *, int, int, const int, const float *, enum hitLocation_t, int);
void CDECL Touch_Item_Auto(struct gentity_s *, struct gentity_s *, int);
void CDECL G_TimedObjectThink(struct gentity_s *);
void CDECL G_PlayerController(struct gentity_s *, int *);
void CDECL turret_use(struct gentity_s *, struct gentity_s *, struct gentity_s *);
void CDECL turret_controller(struct gentity_s *, int *);
void CDECL turret_think(struct gentity_s *);
void CDECL G_VehEntHandler_Think(struct gentity_s *);
void CDECL G_VehEntHandler_Touch(struct gentity_s *, struct gentity_s *, int);
void CDECL G_VehEntHandler_Use(struct gentity_s *, struct gentity_s *, struct gentity_s *);
void CDECL G_VehEntHandler_Pain(struct gentity_s *, struct gentity_s *, int, const float *, const int, const float *, enum hitLocation_t, const int);
void CDECL G_VehEntHandler_Die(struct gentity_s *, struct gentity_s *, struct gentity_s *, int, int, const int, const float *, enum hitLocation_t, int);
void CDECL G_VehEntHandler_Controller(struct gentity_s *, int *);
void CDECL Helicopter_Think(struct gentity_s *);
void CDECL Helicopter_Pain(struct gentity_s *, struct gentity_s *, int, const float *, const int, const float *, enum hitLocation_t, const int);
void CDECL Helicopter_Die(struct gentity_s *, struct gentity_s *, struct gentity_s *, int, int, const int, const float *, enum hitLocation_t, int);
void CDECL Helicopter_Controller(struct gentity_s *, int *);
void CDECL G_ExplodeMissile(struct gentity_s *);
void CDECL BodyEnd(struct gentity_s *);
void CDECL turret_think_init(struct gentity_s *);
void CDECL DroppedItemClearOwner(struct gentity_s *);
void CDECL FinishSpawningItem(struct gentity_s *);
void CDECL use_trigger_use(struct gentity_s *, struct gentity_s *, struct gentity_s *);
