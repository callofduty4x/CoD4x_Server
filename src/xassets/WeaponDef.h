/* Got this structure from CoD4 alpha */
/* This one is patched and most suitable for use */
#pragma once
#include "xassetfwd.h"
#include "xmodel.h"
...
typedef enum activeReticleType_t
{
...
typedef enum ammoCounterClipType_t
{
...
typedef enum WeapOverlayInteface_t
{
...
typedef enum WeapStickinessType_t
{
...
}WeapStickinessType_t;

typedef enum guidedMissileType_t
{
...
typedef struct WeaponDef_t
{
  ...
  XModel_t *gunXModel[16];
  XModel_t *handXModel;
  const char *szXAnims[33];
  const char *szModeName;
  ushort hideTags[8];
  ushort notetrackSoundMapKeys[16];
  ushort notetrackSoundMapValues[16];
  int playerAnimType;
  weapType_t weapType;
  weapClass_t weapClass;
  PenetrateType_t penetrateType;
  ...
  FxEffectDef_t *viewShellEjectEffect;
  FxEffectDef_t *worldShellEjectEffect;
  FxEffectDef_t *viewLastShotEjectEffect;
  FxEffectDef_t *worldLastShotEjectEffect;
  ...
  XModel_t *worldModel[16];
  XModel_t *worldClipModel;
  XModel_t *rocketModel;
  XModel_t *knifeModel;
  XModel_t *worldKnifeModel;
  Material_t *hudIcon;
  weaponIconRatioType_t hudIconRatio;
  Material_t *ammoCounterIcon;
  ...
  Material_t *overlayMaterialLowRes;
  ...
  FxEffectDef_t *projIgnitionEffect;
