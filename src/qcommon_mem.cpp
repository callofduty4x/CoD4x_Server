...
char *CCDECL Z_TryMallocGarbage(int size, const char *name, int type)
{
...
void CCDECL Z_MallocFailed(int size)
{
...
char *CCDECL Z_MallocGarbage(int size, const char *name, int type)
{
  char *buf;
