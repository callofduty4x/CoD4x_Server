...
{
	 perk_weapSpreadMultiplier = Cvar_RegisterFloat( "perk_weapSpreadMultiplier", 0.64999998, 0.0, 1.0, CVAR_CHEAT, "Percentage of weapon spread to use");
	 perk_weapReloadMultiplier = Cvar_RegisterFloat( "perk_weapReloadMultiplier", 0.5, 0.0, 1.0, CVAR_CHEAT, "Percentage of weapon reload time to use");
	 perk_weapRateMultiplier = Cvar_RegisterFloat( "perk_weapRateMultiplier", 0.75, 0.0, 1.0, CVAR_CHEAT, "Percentage of weapon firing rate to use");
	 perk_extraBreath = Cvar_RegisterFloat( "perk_extraBreath", 5.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Number of extra seconds a player can hold his breath");
	 perk_bulletPenetrationMultiplier = Cvar_RegisterFloat( "perk_bulletPenetrationMultiplier", 2.0, 0.0, 30.0, CVAR_CHEAT, "Multiplier for extra bullet penetration");
	 perk_grenadeDeath = Cvar_RegisterString( "perk_grenadeDeath", "frag_grenade_short_mp", CVAR_CHEAT, "Name of the grenade weapon to drop");
	 perk_parabolicRadius = Cvar_RegisterFloat( "perk_parabolicRadius", 400.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Eavesdrop perk's effective radius");
	 perk_parabolicAngle = Cvar_RegisterFloat( "perk_parabolicAngle", 180.0, 0.0, 180.0, CVAR_CHEAT, "Eavesdrop perk's effective FOV angle");
	 perk_parabolicIcon = Cvar_RegisterString( "perk_parabolicIcon", "specialty_parabolic", CVAR_CHEAT, "Eavesdrop icon to use when displaying eavesdropped voice chats");
	 perk_sprintMultiplier = Cvar_RegisterFloat( "perk_sprintMultiplier", 2.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Multiplier for player_sprinttime");
}
...
{
	 vehHelicopterMaxSpeed = Cvar_RegisterFloat( "vehHelicopterMaxSpeed", 150.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "Maximum horizontal speed of the player helicopter (in MPH)");
	 vehHelicopterMaxSpeedVertical = Cvar_RegisterFloat( "vehHelicopterMaxSpeedVertical", 65.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "Maximum vertical speed of the player helicopter (in MPH)");
	 vehHelicopterMaxAccel = Cvar_RegisterFloat( "vehHelicopterMaxAccel", 45.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "Maximum horizontal acceleration of the player helicopter (in MPH per second)");
	 vehHelicopterMaxAccelVertical = Cvar_RegisterFloat( "vehHelicopterMaxAccelVertical", 30.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "Maximum vertical acceleration of the player helicopter (in MPH per second)");
	 vehHelicopterMaxYawRate = Cvar_RegisterFloat( "vehHelicopterMaxYawRate", 120.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "Maximum yaw speed of the player helicopter");
	 vehHelicopterMaxYawAccel = Cvar_RegisterFloat( "vehHelicopterMaxYawAccel", 90.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "Maximum yaw acceleration of the player helicopter");
	 vehHelicopterMaxPitch = Cvar_RegisterFloat( "vehHelicopterMaxPitch", 35.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "Maximum pitch of the player helicopter");
	 vehHelicopterMaxRoll = Cvar_RegisterFloat( "vehHelicopterMaxRoll", 35.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "Maximum roll of the player helicopter");
	 vehHelicopterLookaheadTime = Cvar_RegisterFloat( "vehHelicopterLookaheadTime", 1.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "How far ahead (in seconds) the player helicopter looks ahead, to avoid hard collisions. (Like driving down the highway, you should keep 2 seconds distance between you and the vehicle in front of you)");
	 vehHelicopterHoverSpeedThreshold = Cvar_RegisterFloat( "vehHelicopterHoverSpeedThreshold", 400.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "The speed below which the player helicopter begins to jitter the tilt, for hovering");
	 vehHelicopterRightStickDeadzone = Cvar_RegisterFloat( "vehHelicopterRightStickDeadzone", 0.30000001, 0.0099999998, 1.0, CVAR_CHEAT, "Dead-zone for the axes of the right thumbstick. This helps to better control the two axes separately.");
	 vehHelicopterStrafeDeadzone = Cvar_RegisterFloat( "vehHelicopterStrafeDeadzone", 0.30000001, 0.0099999998, 1.0, CVAR_CHEAT, "Dead-zone so that you can fly straight forward easily without accidentally strafing (and thus rolling).");
	 vehHelicopterScaleMovement = Cvar_RegisterBool( "vehHelicopterScaleMovement", qtrue, CVAR_CHEAT, "Scales down the smaller of the left stick axes.");
	 vehHelicopterSoftCollisions = Cvar_RegisterBool( "vehHelicopterSoftCollisions", 0, CVAR_CHEAT, "Player helicopters have soft collisions (slow down before they collide).");
	 vehHelicopterDecelerationFwd = Cvar_RegisterFloat( "vehHelicopterDecelerationFwd", 0.5, 0.0, 3.4028235e38, CVAR_CHEAT, "Set the deceleration of the player helicopter (as a fraction of acceleration) in the direction the chopper is facing. So 1.0 makes it equal to the acceleration.");
	 vehHelicopterDecelerationSide = Cvar_RegisterFloat( "vehHelicopterDecelerationSide", 1.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Set the side-to-side deceleration of the player helicopter (as a fraction of acceleration). So 1.0 makes it equal to the acceleration.");
	 vehHelicopterInvertUpDown = Cvar_RegisterBool( "vehHelicopterInvertUpDown", 0, CVAR_CHEAT, "Invert the altitude control on the player helicopter.");
	 vehHelicopterYawOnLeftStick = Cvar_RegisterFloat( "vehHelicopterYawOnLeftStick", 5.0, 0.0, 3.4028235e38, CVAR_CHEAT, "The yaw speed created by the left stick when pushing the stick diagonally (e.g., moving forward and strafing slightly).");
	 vehHelicopterTiltSpeed = Cvar_RegisterFloat( "vehHelicopterTiltSpeed", 1.2, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "The rate at which the player helicopter's tilt responds");
	 vehHelicopterTiltFromAcceleration = Cvar_RegisterFloat( "vehHelicopterTiltFromAcceleration", 2.0, 0.0099999998, 3.4028235e38, CVAR_CHEAT, "The amount of tilt caused by acceleration");
	 vehHelicopterTiltFromDeceleration = Cvar_RegisterFloat( "vehHelicopterTiltFromDeceleration", 2.0, 0.0, 3.4028235e38, CVAR_CHEAT, "The amount of tilt caused by deceleration");
	 vehHelicopterTiltFromVelocity = Cvar_RegisterFloat( "vehHelicopterTiltFromVelocity", 1.0, 0.0, 3.4028235e38, CVAR_CHEAT, "The amount of tilt caused by the current velocity");
	 vehHelicopterTiltFromControllerAxes = Cvar_RegisterFloat( "vehHelicopterTiltFromControllerAxes", 0.0, 0.0, 3.4028235e38, CVAR_CHEAT, "The amount of tilt caused by the desired velocity (i.e., the amount of controller stick deflection)");
	 vehHelicopterTiltFromFwdAndYaw = Cvar_RegisterFloat( "vehHelicopterTiltFromFwdAndYaw", 0.0, 0.0, 3.4028235e38, CVAR_CHEAT, "The amount of roll caused by yawing while moving forward.");
	 vehHelicopterTiltFromFwdAndYaw_VelAtMaxTilt = Cvar_RegisterFloat(  "vehHelicopterTiltFromFwdAndYaw_VelAtMaxTilt",  1.0,  0.0,  3.4028235e38,  CVAR_CHEAT,  "The forward speed (as a fraction of top speed) at which the tilt due to yaw reaches is maximum value.");
	 ...
	 vehHelicopterTiltMomentum = Cvar_RegisterFloat( "vehHelicopterTiltMomentum", 0.40000001, 0.000099999997, 3.4028235e38, CVAR_CHEAT, "The amount of rotational momentum the helicopter has with regards to tilting.");
}

void G_VehRegisterCvars()
{
	 vehDebugServer = Cvar_RegisterBool("vehDebugServer", 0, CVAR_CHEAT, "Turn on debug information for vehicles");
	 vehTextureScrollScale = Cvar_RegisterFloat( "vehTextureScrollScale", 0.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Scale vehicle texture scroll scale by this amount (debug only)");
	 vehTestHorsepower = Cvar_RegisterFloat("vehTestHorsepower", 200.0, 0.0, 3.4028235e38, CVAR_CHEAT, "");
	 vehTestWeight = Cvar_RegisterFloat("vehTestWeight", 5200.0, 0.0, 3.4028235e38, CVAR_CHEAT, "lbs");
	 vehTestMaxMPH = Cvar_RegisterFloat("vehTestMaxMPH", 40.0, 0.0, 3.4028235e38, CVAR_CHEAT, "");
}

void G_RegisterMissileCvars()
{

	 missileHellfireMaxSlope = Cvar_RegisterFloat( "missileHellfireMaxSlope", 0.5, 0.0, 3.4028235e38, CVAR_CHEAT, "This limits how steeply the hellfire missile can turn upward when climbing");
	 missileHellfireUpAccel = Cvar_RegisterFloat( "missileHellfireUpAccel", 1000.0, 0.1, 3.4028235e38, CVAR_CHEAT, "The rate at which the hellfire missile curves upward");
	 missileJavClimbHeightDirect = Cvar_RegisterFloat( "missileJavClimbHeightDirect", 10000.0, 0.0, 3.4028235e38, CVAR_CHEAT, "In direct-fire mode, how far above the target the rocket will aim for when climbing.");
	 missileJavClimbHeightTop = Cvar_RegisterFloat( "missileJavClimbHeightTop", 15000.0, 0.0, 3.4028235e38, CVAR_CHEAT, "In top-fire mode, how far above the target the rocket will aim for when climbing.");
	 missileJavClimbAngleDirect = Cvar_RegisterFloat( "missileJavClimbAngleDirect", 85.0, 0.0, 3.4028235e38, CVAR_CHEAT, "In direct-fire mode, the minimum angle between the rocket and target until the rocket stops climbing. Smaller angles make for higher climbs.");
	 missileJavClimbAngleTop = Cvar_RegisterFloat( "missileJavClimbAngleTop", 50.0, 0.0, 3.4028235e38, CVAR_CHEAT, "In top-fire mode, the minimum angle between the rocket and target until the rocket stops climbing. Smaller angles make for higher climbs.");
	 missileJavClimbCeilingDirect = Cvar_RegisterFloat( "missileJavClimbCeilingDirect", 0.0, 0.0, 3.4028235e38, CVAR_CHEAT, "In direct-fire mode, how high the missile needs to reach before it descends.");
	 missileJavClimbCeilingTop = Cvar_RegisterFloat( "missileJavClimbCeilingTop", 3000.0, 0.0, 3.4028235e38, CVAR_CHEAT, "In top-fire mode, how high the missile needs to reach before it descends.");
	 missileJavTurnRateDirect = Cvar_RegisterFloat( "missileJavTurnRateDirect", 60.0, 0.0, 3.4028235e38, CVAR_CHEAT, "In direct-fire mode, how sharp the rocket can turn, in angles/sec.");
	 missileJavTurnRateTop = Cvar_RegisterFloat( "missileJavTurnRateTop", 100.0, 0.0, 3.4028235e38, CVAR_CHEAT, "In top-fire mode, how sharp the rocket can turn, in angles/sec.");
	 missileJavAccelClimb = Cvar_RegisterFloat( "missileJavAccelClimb", 300.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Rocket acceleration when climbing.");
	 missileJavAccelDescend = Cvar_RegisterFloat( "missileJavAccelDescend", 3000.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Rocket acceleration when descending towards target.");
	 missileJavSpeedLimitClimb = Cvar_RegisterFloat( "missileJavSpeedLimitClimb", 1000.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Rocket's speed limit when climbing.");
	 missileJavSpeedLimitDescend = Cvar_RegisterFloat( "missileJavSpeedLimitDescend", 6000.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Rocket's speed limit when descending towards target.");
	 missileJavTurnDecel = Cvar_RegisterFloat("missileJavTurnDecel", 0.050000001, 0.0, 1.0, CVAR_CHEAT, "");
	 missileJavClimbToOwner = Cvar_RegisterFloat( "missileJavClimbToOwner", 700.0, 0.0, 3.4028235e38, CVAR_CHEAT, "");
	 missileWaterMaxDepth = Cvar_RegisterFloat( "missileWaterMaxDepth", 60.0, 0.0, 3.4028235e38, CVAR_CHEAT, "If a missile explodes deeper under water than this, they explosion effect/sound will not play.");
}
...
/*
 ...
 for ( i = (const char *)bgShockChannelNames; ; i += 80 )
 {
	...
	*(v1 - 1) = Cvar_RegisterFloat(i, 0.5, 0.0, 1.0, CVAR_CHEAT, "");
	++v0;
 }*/
}
...
void BG_RegisterCvars()
{
	...
	"underwater", "drugged", "dizzy", "psychotic", NULL };
	 ...
	 bg_viewKickScale = Cvar_RegisterFloat( "bg_viewKickScale", 0.2, 0.0, 10.0, CVAR_CHEAT, "The scale to apply to the damage done to caluclate damage view kick");
	 bg_viewKickMax = Cvar_RegisterFloat("bg_viewKickMax", 90.0, 0.0, 90.0, CVAR_CHEAT, "The maximum view kick");
	 bg_viewKickMin = Cvar_RegisterFloat("bg_viewKickMin", 5.0, 0.0, 90.0, CVAR_CHEAT, "The minimum view kick");
	 bg_viewKickRandom = Cvar_RegisterFloat( "bg_viewKickRandom", 0.40000001, 0.0, 1.0, CVAR_CHEAT, "The random direction scale view kick");
	 ...
	 bg_swingSpeed = Cvar_RegisterFloat( "bg_swingSpeed", 0.2, 0.0, 1.0, CVAR_CHEAT, "The rate at which the player's legs swing around when strafing(multi-player only)");
	 bg_legYawTolerance = Cvar_RegisterFloat( "bg_legYawTolerance", 20.0, 0.0, 180.0, CVAR_CHEAT, "The amount the player's leg yaw can differ from his torso before moving ta match");
	 ...
	 player_move_factor_on_torso = Cvar_RegisterFloat( "player_move_factor_on_torso", 0.0, 0.0, 1.0, CVAR_CHEAT, "The contribution movement direction has on player torso direction(multi-player only)");
	 player_debugHealth = Cvar_RegisterBool( "player_debugHealth", 0, 0x180u, "Turn on debugging info for player health");
	 player_sustainAmmo = Cvar_RegisterBool( "player_sustainAmmo", 0, CVAR_CHEAT, "Firing weapon will not decrease clip ammo.");
	 ...
	 bg_shock_soundLoop = Cvar_RegisterString("bg_shock_soundLoop", "shellshock_loop", CVAR_CHEAT, "Shellshock loop alias");
	 bg_shock_soundLoopSilent = Cvar_RegisterString( "bg_shock_soundLoopSilent", "shellshock_loop_silent", CVAR_CHEAT, "The sound that gets blended with the shellshock loop alias");
	 bg_shock_soundEnd = Cvar_RegisterString("bg_shock_soundEnd", "shellshock_end", CVAR_CHEAT, "Shellshock end sound alias");
	 bg_shock_soundEndAbort = Cvar_RegisterString( "bg_shock_soundEndAbort", "shellshock_end_abort", CVAR_CHEAT, "Shellshock aborted end sound alias");
	 bg_shock_screenType = Cvar_RegisterEnum( "bg_shock_screenType", bg_ShockScreenTypeNames, 0, CVAR_CHEAT, "Shell shock screen effect type");
	 bg_shock_screenBlurBlendTime = Cvar_RegisterFloat( "bg_shock_screenBlurBlendTime", 0.40000001, 0.001, 10.0, CVAR_CHEAT, "The amount of time in seconds for the shellshock effect to blend");
	 bg_shock_screenBlurBlendFadeTime = Cvar_RegisterFloat( "bg_shock_screenBlurBlendFadeTime", 1.0, 0.001, 1000.0, CVAR_CHEAT, "The amount of time in seconds for the shellshock effect to fade");
	 bg_shock_screenFlashWhiteFadeTime = Cvar_RegisterFloat( "bg_shock_screenFlashWhiteFadeTime", 1.0, 0.0, 1000.0, CVAR_CHEAT, "In seconds, how soon from the end of the effect to start blending out the whiteout layer.");
	 bg_shock_screenFlashShotFadeTime = Cvar_RegisterFloat( "bg_shock_screenFlashShotFadeTime", 1.0, 0.0, 1000.0, CVAR_CHEAT, "In seconds, how soon from the end of the effect to start blending out the screengrab layer.");
	 bg_shock_viewKickPeriod = Cvar_RegisterFloat( "bg_shock_viewKickPeriod", 0.75, 0.001, 1000.0, CVAR_CHEAT, "The period of the shellshock view kick effect");
	 bg_shock_viewKickRadius = Cvar_RegisterFloat( "bg_shock_viewKickRadius", 0.050000001, 0.0, 1.0, CVAR_CHEAT, "Shell shock kick radius");
	 bg_shock_viewKickFadeTime = Cvar_RegisterFloat( "bg_shock_viewKickFadeTime", 3.0, 0.001, 1000.0, CVAR_CHEAT, "The time for the shellshock kick effect to fade");
	 bg_shock_sound = Cvar_RegisterBool("bg_shock_sound", qtrue, CVAR_CHEAT, "Play shell shock sound");
	 bg_shock_soundFadeInTime = Cvar_RegisterFloat( "bg_shock_soundFadeInTime", 0.25, 0.001, 1000.0, CVAR_CHEAT, "Shell shock sound fade in time in seconds");
	 bg_shock_soundFadeOutTime = Cvar_RegisterFloat( "bg_shock_soundFadeOutTime", 2.5, 0.001, 1000.0, CVAR_CHEAT, "Shell shock sound fade out time in seconds");
	 bg_shock_soundLoopFadeTime = Cvar_RegisterFloat( "bg_shock_soundLoopFadeTime", 1.5, 0.001, 1000.0, CVAR_CHEAT, "Shell shock sound loop fade time in seconds");
	 bg_shock_soundLoopEndDelay = Cvar_RegisterFloat( "bg_shock_soundLoopEndDelay", -3.0, -10.0, 1000.0, CVAR_CHEAT, "Sound loop end offset time from the end of the shellshock in seconds");
	 bg_shock_soundRoomType = Cvar_RegisterEnum( "bg_shock_soundRoomType", bg_soundRoomTypes, 0, CVAR_CHEAT, "Shell shock sound room type");
	 bg_shock_soundDryLevel = Cvar_RegisterFloat( "bg_shock_soundDryLevel", 1.0, 0.0, 1.0, CVAR_CHEAT, "Shell shock sound dry level");
	 bg_shock_soundWetLevel = Cvar_RegisterFloat( "bg_shock_soundWetLevel", 0.5, 0.0, 1.0, CVAR_CHEAT, "Shell shock sound wet level");
	 bg_shock_soundModEndDelay = Cvar_RegisterFloat( "bg_shock_soundModEndDelay", 2.0, -1000.0, 1000.0, CVAR_CHEAT, "The delay from the end of the shell shock to the end of the sound modification");
	 BG_RegisterShockVolumeCvars();
	 bg_shock_lookControl = Cvar_RegisterBool( "bg_shock_lookControl", qtrue, CVAR_CHEAT, "Alter player control during shellshock");
	 bg_shock_lookControl_maxpitchspeed = Cvar_RegisterFloat( "bg_shock_lookControl_maxpitchspeed", 90.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Maximum pitch movement rate while shellshocked in degrees per second");
	 bg_shock_lookControl_maxyawspeed = Cvar_RegisterFloat( "bg_shock_lookControl_maxyawspeed", 90.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Maximum yaw movement rate while shell shocked in degrees per second");
	 bg_shock_lookControl_mousesensitivityscale = Cvar_RegisterFloat( "bg_shock_lookControl_mousesensitivityscale", 0.5, 0.0, 2.0, CVAR_CHEAT, "Sensitivity scale to apply to a shellshocked player");
	 bg_shock_lookControl_fadeTime = Cvar_RegisterFloat( "bg_shock_lookControl_fadeTime", 2.0, 0.001, 1000.0, CVAR_CHEAT, "The time for the shellshock player control to fade in seconds");
	 bg_shock_movement = Cvar_RegisterBool( "bg_shock_movement", qtrue, CVAR_CHEAT, "Affect player's movement speed duringi shellshock");
	 player_meleeRange = Cvar_RegisterFloat( "player_meleeRange", 64.0, 0.0, 1000.0, CVAR_CHEAT, "The maximum range of the player's mellee attack");
	 player_meleeWidth = Cvar_RegisterFloat( "player_meleeWidth", 10.0, 0.0, 1000.0, CVAR_CHEAT, "The width of the player's melee attack");
	 player_meleeHeight = Cvar_RegisterFloat( "player_meleeHeight", 10.0, 0.0, 1000.0, CVAR_CHEAT, "The height of the player's melee attack");
	 player_meleeChargeFriction = Cvar_RegisterFloat( "player_meleeChargeFriction", 1200.0, 1.0, 5000.0, CVAR_CHEAT, "Friction used during melee charge");
	 player_burstFireCooldown = Cvar_RegisterFloat( "player_burstFireCooldown", 0.2, 0.0, 60.0, CVAR_CHEAT, "Seconds after a burst fire before weapons can be fired again.");
	 bullet_penetrationMinFxDist = Cvar_RegisterFloat( "bullet_penetrationMinFxDist", 30.0, 0.0, 1024.0, CVAR_CHEAT, "Min distance a penetrated bullet must travel before it'll trigger the effects");
	 Jump_RegisterCvars();
...
void __cdecl G_RegisterCvars()
{
	...
	static const char *g_entinfoNames[] = { "off", "all_ents", NULL };
	 ...
	 Cvar_RegisterString("gamename", "Call of Duty 4", CVAR_ROM | CVAR_SERVERINFO, "The name of the game");
	 Cvar_RegisterString("gamedate", "Feb 12 2009", CVAR_ROM, "The date compiled");
	 Cvar_RegisterString("sv_mapname", "", 0x44u, "The current map name");
	 g_gametype = Cvar_RegisterString("g_gametype", "war", CVAR_LATCH | CVAR_SERVERINFO, "The current campaign");
	 ...
	 g_synchronousClients = Cvar_RegisterBool("g_synchronousClients", 0, CVAR_SYSTEMINFO, "Call 'client think' exactly once for each server frame to make smooth demos");
	 g_log = Cvar_RegisterString("g_log", "games_mp.log", CVAR_ARCHIVE, "Log file name");
	 g_logTimeStampInSeconds = Cvar_RegisterBool("g_logTimeStampInSeconds", 0, CVAR_ARCHIVE, "Enable logging with time stamps in seconds since UTC 1/1/1970");
	 g_logSync = Cvar_RegisterBool("g_logSync", 0, CVAR_ARCHIVE, "Enable synchronous logging");
	 g_banIPs = Cvar_RegisterString("g_banIPs", "", CVAR_ARCHIVE, "IP addresses to ban from playing");
	 ...
	 g_debugDamage = Cvar_RegisterBool("g_debugDamage", 0, CVAR_CHEAT, "Show debug information for damage");
	 g_debugBullets = Cvar_RegisterInt("g_debugBullets", 0, -3, 6, CVAR_CHEAT, "Show debug information for bullets");
	 bullet_penetrationEnabled = Cvar_RegisterBool("bullet_penetrationEnabled", qtrue, CVAR_CHEAT, "Enable/Disable bullet penetration.");
	 g_entinfo = Cvar_RegisterEnum("g_entinfo", g_entinfoNames, 0, CVAR_CHEAT, "Display entity information");
	 g_motd = Cvar_RegisterString("g_motd", "", 0, "The message of the day");
	 g_playerCollisionEjectSpeed = Cvar_RegisterInt("g_playerCollisionEjectSpeed", 25, 0, 32000, CVAR_ARCHIVE, "Speed at which to push intersecting players away from each other");
	 g_dropForwardSpeed = Cvar_RegisterFloat("g_dropForwardSpeed", 10.0, 0.0, 1000.0, CVAR_ARCHIVE, "Forward speed of a dropped item");
	 g_dropUpSpeedBase = Cvar_RegisterFloat("g_dropUpSpeedBase", 10.0, 0.0, 1000.0, CVAR_ARCHIVE, "Base component of the initial vertical speed of a dropped item");
	 g_dropUpSpeedRand = Cvar_RegisterFloat("g_dropUpSpeedRand", 5.0, 0.0, 1000.0, CVAR_ARCHIVE, "Random component of the initial vertical speed of a dropped item");
	 g_dropHorzSpeedRand = Cvar_RegisterFloat("g_dropHorzSpeedRand", 100.0, 0.0, 1000.0, CVAR_ARCHIVE, "Random component of the initial horizontal speed of a dropped item");
	 g_clonePlayerMaxVelocity = Cvar_RegisterFloat("g_clonePlayerMaxVelocity", 80.0, 0.0, 3.4028235e38, CVAR_ARCHIVE, "Maximum velocity in each axis of a cloned player\n(for death animations)");
	 voice_global = Cvar_RegisterBool("voice_global", 0, CVAR_ARCHIVE, "Send voice messages to everybody");
	 voice_localEcho = Cvar_RegisterBool("voice_localEcho", 0, CVAR_ARCHIVE, "Echo voice chat back to the player");
	 voice_deadChat = Cvar_RegisterBool("voice_deadChat", 0, CVAR_ARCHIVE, "Allow dead players to talk to living players");
	 ...
	 g_deadChat = Cvar_RegisterBool("g_deadChat", 0, CVAR_ARCHIVE, "Allow dead players to chat with living players");
	 g_voiceChatTalkingDuration = Cvar_RegisterInt("g_voiceChatTalkingDuration", 500, 0, 10000, CVAR_ARCHIVE, "Time after the last talk packet was received that the player is considered by the\nserver to still be talking in milliseconds");
	 ...
	 g_antilag = Cvar_RegisterBool("g_antilag", qtrue, CVAR_ROM, "Turn on antilag checks for weapon hits");
	 g_oldVoting = Cvar_RegisterBool("g_oldVoting", qtrue, CVAR_ARCHIVE, "Use old voting method");
	 g_voteAbstainWeight = Cvar_RegisterFloat( "g_voteAbstainWeight", 0.5, 0.0, 1.0, CVAR_ARCHIVE, "How much an abstained vote counts as a 'no' vote");
	 g_NoScriptSpam = Cvar_RegisterBool("g_no_script_spam", 0, 0, "Turn off script debugging info");
	 g_debugLocDamage = Cvar_RegisterBool( "g_debugLocDamage", 0, CVAR_CHEAT, "Turn on debugging information for locational damage");
	 g_friendlyfireDist = Cvar_RegisterFloat( "g_friendlyfireDist", 256.0, 0.0, 15000.0, CVAR_CHEAT, "Maximum range for disabling fire at a friendly");
	 g_friendlyNameDist = Cvar_RegisterFloat( "g_friendlyNameDist", 15000.0, 0.0, 15000.0, CVAR_CHEAT, "Maximum range for seeing a friendly's name");
	 melee_debug = Cvar_RegisterBool("melee_debug", 0, CVAR_CHEAT, "Turn on debug lines for melee traces");
	 radius_damage_debug = Cvar_RegisterBool( "radius_damage_debug", 0, CVAR_CHEAT, "Turn on debug lines for radius damage traces");
	 player_throwbackInnerRadius = Cvar_RegisterFloat( "player_throwbackInnerRadius", 90.0, 0.0, 3.4028235e38, CVAR_CHEAT, "The radius to a live grenade player must be within initially to do a throwback");
	 player_throwbackOuterRadius = Cvar_RegisterFloat( "player_throwbackOuterRadius", 160.0, 0.0, 3.4028235e38, CVAR_CHEAT, "The radius player is allow to throwback a grenade once the player has been in the inner radius");
	 player_MGUseRadius = Cvar_RegisterFloat( "player_MGUseRadius", 128.0, 0.0, 3.4028235e38, CVAR_CHEAT, "The radius within which a player can mount a machine gun");
	 g_minGrenadeDamageSpeed = Cvar_RegisterFloat( "g_minGrenadeDamageSpeed", 400.0, 0.0, 3.4028235e38, CVAR_CHEAT, "Minimum speed at which getting hit be a grenade will do damage (not the grenade explosion damage)");
	 g_compassShowEnemies = Cvar_RegisterBool( "g_compassShowEnemies", 0, CVAR_CHEAT | CVAR_SERVERINFO, "Whether enemies are visible on the compass at all times");
	 pickupPrints = Cvar_RegisterBool( "pickupPrints", 0, CVAR_CHEAT, "Print a message to the game window when picking up ammo, etc.");
	 g_dumpAnims = Cvar_RegisterInt( "g_dumpAnims", -1, -1, 1023, CVAR_CHEAT, "Animation debugging info for the given character number");
	 g_useholdtime = Cvar_RegisterInt( "g_useholdtime", 0, 0, 2147483647, 0, "Time to hold the 'use' button to activate use");
	 g_useholdspawndelay = Cvar_RegisterInt( "g_useholdspawndelay", 500, 0, 1000, CVAR_CHEAT | CVAR_ARCHIVE, "Time in milliseconds that the player is unable to 'use' after spawning");
	 g_redCrosshairs = Cvar_RegisterBool("g_redCrosshairs", qtrue, CVAR_LATCH | CVAR_ARCHIVE, "Whether red crosshairs are enabled");
	 g_mantleBlockTimeBuffer = Cvar_RegisterInt("g_mantleBlockTimeBuffer", 500, 0, 60000, CVAR_CHEAT, "Time that the client think is delayed after mantling");
