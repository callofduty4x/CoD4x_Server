...
static cvar_t*  g_cheats;
cvar_t*  g_gametype;
static cvar_t*  g_synchronousClients;
static cvar_t*  g_log;
static cvar_t*  g_logSync;
cvar_t*  g_logTimeStampInSeconds;
static cvar_t*  g_banIPs;
static cvar_t*  g_gravity;
static cvar_t*  g_knockback;
static cvar_t*  g_maxDroppedWeapons;
static cvar_t*  g_inactivity;
static cvar_t*  g_debugDamage;
cvar_t*  g_debugBullets;
static cvar_t*  bullet_penetrationEnabled;
static cvar_t*  g_entinfo;
static cvar_t*  g_motd;
static cvar_t*  g_dropForwardSpeed;
static cvar_t*  g_dropUpSpeedBase;
static cvar_t*  g_dropUpSpeedRand;
static cvar_t*  g_dropHorzSpeedRand;
static cvar_t*  g_clonePlayerMaxVelocity;
static cvar_t*  voice_global;
static cvar_t*  voice_localEcho;
static cvar_t*  voice_deadChat;
static cvar_t*  g_allowVote;
static cvar_t*  g_listEntity;
static cvar_t*  g_deadChat;
static cvar_t*  g_voiceChatTalkingDuration;
static cvar_t*  g_TeamIcon_Allies;
static cvar_t*  g_TeamIcon_Axis;
static cvar_t*  g_TeamIcon_Free;
static cvar_t*  g_TeamIcon_Spectator;
static cvar_t*  g_ScoresColor_MyTeam;
static cvar_t*  g_ScoresColor_EnemyTeam;
static cvar_t*  g_ScoresColor_Spectator;
static cvar_t*  g_ScoresColor_Free;
static cvar_t*  g_ScoresColor_Allies;
static cvar_t*  g_ScoresColor_Axis;
// static cvar_t*  g_TeamName_Allies;
// static cvar_t*  g_TeamName_Axis;
static cvar_t*  g_TeamColor_Allies;
static cvar_t*  g_TeamColor_Axis;
static cvar_t*  g_TeamColor_MyTeam;
static cvar_t*  g_TeamColor_EnemyTeam;
static cvar_t*  g_TeamColor_Spectator;
static cvar_t*  g_TeamColor_Free;
cvar_t*  g_smoothClients;
static cvar_t*  g_antilag;
static cvar_t*  g_oldVoting;
static cvar_t*  g_voteAbstainWeight;
static cvar_t*  g_NoScriptSpam;
static cvar_t*  g_debugLocDamage;
static cvar_t*  g_friendlyfireDist;
static cvar_t*  g_friendlyNameDist;
static cvar_t*  melee_debug;
static cvar_t*  radius_damage_debug;
static cvar_t*  player_throwbackInnerRadius;
static cvar_t*  player_throwbackOuterRadius;
static cvar_t*  player_MGUseRadius;
static cvar_t*  g_minGrenadeDamageSpeed;
static cvar_t*  g_compassShowEnemies;
static cvar_t*  pickupPrints;
static cvar_t*  g_dumpAnims;
static cvar_t*  g_useholdtime;
static cvar_t*  g_useholdspawndelay;
static cvar_t*  g_redCrosshairs;
static cvar_t*  g_mantleBlockTimeBuffer;
static cvar_t*  g_fogColorReadOnly;
static cvar_t*  g_fogStartDistReadOnly;
static cvar_t*  g_fogHalfDistReadOnly;

/* Vehicle Cvars */

static cvar_t*  vehHelicopterMaxSpeed;
static cvar_t*  vehHelicopterMaxSpeedVertical;
static cvar_t*  vehHelicopterMaxAccel;
static cvar_t*  vehHelicopterMaxAccelVertical;
static cvar_t*  vehHelicopterMaxYawRate;
static cvar_t*  vehHelicopterMaxYawAccel;
static cvar_t*  vehHelicopterMaxPitch;
static cvar_t*  vehHelicopterMaxRoll;
static cvar_t*  vehHelicopterLookaheadTime;
static cvar_t*  vehHelicopterHoverSpeedThreshold;
static cvar_t*  vehHelicopterRightStickDeadzone;
static cvar_t*  vehHelicopterStrafeDeadzone;
static cvar_t*  vehHelicopterScaleMovement;
static cvar_t*  vehHelicopterSoftCollisions;
static cvar_t*  vehHelicopterDecelerationFwd;
static cvar_t*  vehHelicopterDecelerationSide;
static cvar_t*  vehHelicopterInvertUpDown;
static cvar_t*  vehHelicopterYawOnLeftStick;
static cvar_t*  vehHelicopterTiltSpeed;
static cvar_t*  vehHelicopterTiltFromAcceleration;
static cvar_t*  vehHelicopterTiltFromDeceleration;
static cvar_t*  vehHelicopterTiltFromVelocity;
static cvar_t*  vehHelicopterTiltFromControllerAxes;
static cvar_t*  vehHelicopterTiltFromFwdAndYaw;
static cvar_t*  vehHelicopterTiltFromFwdAndYaw_VelAtMaxTilt;
static cvar_t*  vehHelicopterJitterJerkyness;
static cvar_t*  vehHelicopterHeadSwayDontSwayTheTurret;
static cvar_t*  vehHelicopterTiltMomentum;
static cvar_t*  vehDebugServer;
static cvar_t*  vehTextureScrollScale;
static cvar_t*  vehTestHorsepower;
static cvar_t*  vehTestWeight;
static cvar_t*  vehTestMaxMPH;


/* Missle Cvars */

static cvar_t*  missileHellfireMaxSlope;
static cvar_t*  missileHellfireUpAccel;
static cvar_t*  missileJavClimbHeightDirect;
static cvar_t*  missileJavClimbHeightTop;
static cvar_t*  missileJavClimbAngleDirect;
static cvar_t*  missileJavClimbAngleTop;
static cvar_t*  missileJavClimbCeilingDirect;
static cvar_t*  missileJavClimbCeilingTop;
static cvar_t*  missileJavTurnRateDirect;
static cvar_t*  missileJavTurnRateTop;
static cvar_t*  missileJavAccelClimb;
static cvar_t*  missileJavAccelDescend;
static cvar_t*  missileJavSpeedLimitClimb;
static cvar_t*  missileJavSpeedLimitDescend;
static cvar_t*  missileJavTurnDecel;
static cvar_t*  missileJavClimbToOwner;
static cvar_t*  missileWaterMaxDepth;


/* Missle Debug Cvars */

static cvar_t*  missileDebugDraw;
static cvar_t*  missileDebugText;
static cvar_t*  missileDebugAttractors;
...
static cvar_t*  bg_viewKickScale;
static cvar_t*  bg_viewKickMax;
static cvar_t*  bg_viewKickMin;
static cvar_t*  bg_viewKickRandom;
static cvar_t*  player_view_pitch_up;
static cvar_t*  player_view_pitch_down;
static cvar_t*  player_lean_shift_left;
static cvar_t*  player_lean_shift_right;
static cvar_t*  player_lean_shift_crouch_left;
static cvar_t*  player_lean_shift_crouch_right;
static cvar_t*  player_lean_rotate_left;
static cvar_t*  player_lean_rotate_right;
static cvar_t*  player_lean_rotate_crouch_left;
static cvar_t*  player_lean_rotate_crouch_right;
static cvar_t*  bg_ladder_yawcap;
static cvar_t*  bg_prone_yawcap;
static cvar_t*  bg_foliagesnd_minspeed;
static cvar_t*  bg_foliagesnd_maxspeed;
static cvar_t*  bg_foliagesnd_slowinterval;
static cvar_t*  bg_foliagesnd_fastinterval;
static cvar_t*  bg_foliagesnd_resetinterval;
static cvar_t*  bg_fallDamageMinHeight;
static cvar_t*  bg_fallDamageMaxHeight;
static cvar_t*  inertiaMax;
static cvar_t*  inertiaDebug;
static cvar_t*  inertiaAngle;
static cvar_t*  friction;
static cvar_t*  stopspeed;
static cvar_t*  bg_swingSpeed;
static cvar_t*  bg_legYawTolerance;
static cvar_t*  bg_bobAmplitudeSprinting;
static cvar_t*  bg_bobAmplitudeStanding;
static cvar_t*  bg_bobAmplitudeDucked;
static cvar_t*  bg_bobAmplitudeProne;
static cvar_t*  bg_bobMax;
static cvar_t*  bg_aimSpreadMoveSpeedThreshold;
static cvar_t*  bg_maxGrenadeIndicatorSpeed;
static cvar_t*  player_breath_hold_time;
static cvar_t*  player_breath_gasp_time;
static cvar_t*  player_breath_fire_delay;
static cvar_t*  player_breath_gasp_scale;
static cvar_t*  player_breath_hold_lerp;
static cvar_t*  player_breath_gasp_lerp;
static cvar_t*  player_breath_snd_lerp;
static cvar_t*  player_breath_snd_delay;
static cvar_t*  player_scopeExitOnDamage;
static cvar_t*  player_adsExitDelay;
static cvar_t*  player_move_factor_on_torso;
static cvar_t*  player_debugHealth;
static cvar_t*  player_sustainAmmo;
static cvar_t*  player_moveThreshhold;
static cvar_t*  player_footstepsThreshhold;
static cvar_t*  player_strafeSpeedScale;
static cvar_t*  player_backSpeedScale;
static cvar_t*  player_strafeAnimCosAngle;
static cvar_t*  player_spectateSpeedScale;
static cvar_t*  player_sprintForwardMinimum;
static cvar_t*  player_sprintSpeedScale;
static cvar_t*  player_sprintTime;
static cvar_t*  player_sprintMinTime;
static cvar_t*  player_sprintRechargePause;
static cvar_t*  player_sprintStrafeSpeedScale;
static cvar_t*  player_sprintCameraBob;
static cvar_t*  player_turnAnims;
static cvar_t*  player_dmgtimer_timePerPoint;
static cvar_t*  player_dmgtimer_maxTime;
static cvar_t*  player_dmgtimer_minScale;
static cvar_t*  player_dmgtimer_stumbleTime;
static cvar_t*  player_dmgtimer_flinchTime;
static cvar_t*  bg_shock_soundEnd;
static cvar_t*  bg_shock_soundEndAbort;
static cvar_t*  bg_shock_screenType;
static cvar_t*  bg_shock_screenBlurBlendTime;
static cvar_t*  bg_shock_screenBlurBlendFadeTime;
static cvar_t*  bg_shock_screenFlashWhiteFadeTime;
static cvar_t*  bg_shock_screenFlashShotFadeTime;
static cvar_t*  bg_shock_viewKickPeriod;
static cvar_t*  bg_shock_viewKickRadius;
static cvar_t*  bg_shock_viewKickFadeTime;
static cvar_t*  bg_shock_sound;
static cvar_t*  bg_shock_soundLoop;
static cvar_t*  bg_shock_soundLoopSilent;
static cvar_t*  bg_shock_sound;
static cvar_t*  bg_shock_soundFadeInTime;
static cvar_t*  bg_shock_soundFadeOutTime;
static cvar_t*  bg_shock_soundLoopFadeTime;
static cvar_t*  bg_shock_soundLoopEndDelay;
static cvar_t*  bg_shock_soundRoomType;
static cvar_t*  bg_shock_soundDryLevel;
static cvar_t*  bg_shock_soundWetLevel;
static cvar_t*  bg_shock_soundModEndDelay;
static cvar_t*  bg_shock_lookControl;
static cvar_t*  bg_shock_lookControl_maxpitchspeed;
static cvar_t*  bg_shock_lookControl_maxyawspeed;
static cvar_t*  bg_shock_lookControl_mousesensitivityscale;
static cvar_t*  bg_shock_lookControl_fadeTime;
static cvar_t*  bg_shock_movement;
static cvar_t*  player_meleeRange;
static cvar_t*  player_meleeWidth;
static cvar_t*  player_meleeHeight;
static cvar_t*  player_meleeChargeFriction;
static cvar_t*  player_burstFireCooldown;
static cvar_t*  bullet_penetrationMinFxDist;
...
static cvar_t*  jump_ladderPushVel;
static cvar_t*  jump_spreadAdd;


/* BG Mantle Cvars */


static cvar_t*  mantle_enable;
static cvar_t*  mantle_debug;
static cvar_t*  mantle_check_range;
static cvar_t*  mantle_check_radius;
static cvar_t*  mantle_check_angle;
static cvar_t*  mantle_view_yawcap;


/* BG Perk Cvars */


static cvar_t*  perk_weapSpreadMultiplier;
static cvar_t*  perk_weapReloadMultiplier;
static cvar_t*  perk_weapRateMultiplier;
static cvar_t*  perk_extraBreath;
static cvar_t*  perk_bulletPenetrationMultiplier;
static cvar_t*  perk_grenadeDeath;
static cvar_t*  perk_parabolicRadius;
static cvar_t*  perk_parabolicAngle;
static cvar_t*  perk_parabolicIcon;
static cvar_t*  perk_sprintMultiplier;
