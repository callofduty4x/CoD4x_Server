...
void Scr_AddStockFunctions()
{
	...
	Scr_AddFunction("getdvar", GScr_GetDvar, 0 );
	Scr_AddFunction("getdvarint", GScr_GetDvarInt, 0 );
	Scr_AddFunction("getdvarfloat", GScr_GetDvarFloat, 0 );
	Scr_AddFunction("setdvar", GScr_SetDvar, 0 );
	...
	Scr_AddFunction("makedvarserverinfo", GScr_MakeDvarServerInfo, 0 );
	...
	Scr_AddFunction("openfile", GScr_OpenFile, 1 );
	Scr_AddFunction("closefile", GScr_CloseFile, 1 );
	Scr_AddFunction("fprintln", GScr_FPrintln, 1 );
	Scr_AddFunction("fprintfields", GScr_FPrintFields, 1 );
	Scr_AddFunction("freadln", GScr_FReadLn, 1 );
...
//	Scr_AddMethod("destroy", HECmd_Destroy, 0 );
	...
	Scr_AddMethod("getstat", GScr_GetStat, 0 );
	Scr_AddMethod("setstat", GScr_SetStat, 0 );
...
__cdecl unsigned int Scr_LoadScript(const char *scriptname, PrecacheEntry *precache, int iarg_02)
{
    ...
    else
    {
        ...
        */
        ...
        object = GetObjectA(GetVariable(scrCompilePub.scriptsPos, handle));
