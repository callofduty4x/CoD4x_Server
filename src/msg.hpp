...
void CCDECL MSG_WriteDeltaPlayerstate(struct snapshotInfo_s* , msg_t* , int , struct playerState_s* , struct playerState_s*);
...
void CCDECL MSG_WriteEntityIndex(struct snapshotInfo_s*, msg_t*, int, int);
void CCDECL MSG_ReadDeltaUsercmdKey( msg_t *msg, int key, struct usercmd_s *from, struct usercmd_s *to );
void CCDECL MSG_SetDefaultUserCmd( struct playerState_s *ps, struct usercmd_s *ucmd );
