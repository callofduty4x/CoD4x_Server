...
void CCDECL SV_DropClientInternal( client_t *drop, const char *reason, qboolean notifyOthers ) {
	int i;
	int clientnum;
	char var_01[2];
...
void CCDECL SV_DropClient( client_t *drop, const char *reason )
{
...
void CCDECL SV_DropClientNoNotify( client_t *drop, const char *reason )
{
...
void CCDECL SV_WriteDownloadToClient( client_t *cl ) {
...
void CCDECL SV_FreeClient(client_t *cl)
{
...
void CCDECL SV_ClientThink(client_t *cl, struct usercmd_s *cmd)
{
