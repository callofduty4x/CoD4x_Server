...
;All cstrings:
SECTION .rdata
_cstring_aspyrbuilddepotc:		db "/AspyrBuild/depot/CoD4/PC/src/universal/physicalmemory.cpp"
_cstring_need_i_more_byte:		db "Need %i more bytes of ram for alloc to succeed\n"
_cstring_1818s_51f:		db "%-18.18s %5.1f\n"
_cstring_free_physical___:		db "free physical      %5.1f\n"
_cstring_:		db "------------------------\n"
