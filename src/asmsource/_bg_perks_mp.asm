...
;Exports of bg_perks_mp:
	global bg_perkNames
	global Perks_RegisterDvars
	global BG_GetPerkIndexForName
...
BG_GetPerkIndexForName:
	...
	mov edi, [ebp+0x8]
	test edi, edi
	jz BG_GetPerkIndexForName_10
	xor esi, esi
	mov ebx, bg_perkNames
	jmp BG_GetPerkIndexForName_20
BG_GetPerkIndexForName_30:
	add esi, 0x1
	add ebx, 0x4
	cmp esi, 0x14
	jz BG_GetPerkIndexForName_10
BG_GetPerkIndexForName_20:
	mov eax, [ebx]
	mov [esp+0x4], eax
	mov [esp], edi
	call Q_stricmp
	test eax, eax
	jnz BG_GetPerkIndexForName_30
	mov eax, esi
	add esp, 0x1c
	pop ebx
	pop esi
