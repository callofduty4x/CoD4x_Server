;Imports of bg_pmove:
	...
	extern notMovingAnims
	extern bobFactorTable
	extern moveAnimTable
	extern playerMaxs
	extern playerMins
...
PM_Footsteps_200:
	mov edx, [ebp-0x34]
	lea eax, [edx+edi*2]
	movss xmm2, dword [eax*4+bobFactorTable]
