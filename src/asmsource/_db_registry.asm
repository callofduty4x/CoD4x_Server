...
DB_ShutdownXAssets_50:
	lea eax, [ebx+g_zoneHandles]
	movzx eax, byte [eax]
	xor edx, edx
	call DB_UnloadXZone
	sub ebx, 0x1
	jns DB_ShutdownXAssets_50
