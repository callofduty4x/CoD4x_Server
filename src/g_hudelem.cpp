...
game_hudelem_field_t g_he_fields[] =
{
    ...
    { "fontscale", HUDELEM_OFS(elem.fontScale), F_FLOAT, 0xffffffff, 0, HudElem_SetFontScale, nullptr },
    { "font", HUDELEM_OFS(elem.font), F_INT, 0xffffffff, 0, HudElem_SetFont, HudElem_GetFont },
    ...
    { "color", HUDELEM_OFS(elem.color), F_INT, 0xffffffff, 0, HudElem_SetColor, HudElem_GetColor },
    { "alpha", HUDELEM_OFS(elem.color), F_INT, 0xffffffff, 0, HudElem_SetAlpha, HudElem_GetAlpha },
    { "label", HUDELEM_OFS(elem.label), F_INT, 0xffffffff, 0, HudElem_SetLocalizedString, nullptr },
    { "sort", HUDELEM_OFS(elem.color), F_FLOAT, 0, 0, nullptr, nullptr },
    { "foreground", HUDELEM_OFS(elem.flags), F_INT, 0xffffffff, 0, HudElem_SetFlagForeground, HudElem_GetFlagForeground },
    { "hidewhendead", HUDELEM_OFS(elem.flags), F_INT, 0xffffffff, 0, HudElem_SetFlagHideWhenDead, HudElem_GetFlagHideWhenDead },
    { "hidewheninmenu", HUDELEM_OFS(elem.flags), F_INT, 0xffffffff, 0, HudElem_SetFlagHideWhenInMenu, HudElem_GetFlagHideWhenInMenu },
    { "glowcolor", HUDELEM_OFS(elem.glowColor), F_INT, 0xffffffff, 0, HudElem_SetGlowColor, HudElem_GetGlowColor },
    { "glowalpha", HUDELEM_OFS(elem.glowColor), F_INT, 0xffffffff, 0, HudElem_SetGlowAlpha, HudElem_GetGlowAlpha },
    { "archived", HUDELEM_OFS(archived), F_INT, 0xffffffff, 0, HudElem_SetBoolean, nullptr },
