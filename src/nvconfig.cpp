...
void NV_WriteConfig()
{
    ...
    char* buffer = reinterpret_cast<char*>(Hunk_AllocateTempMemory(MAX_NVCONFIG_SIZE));
    if(!buffer)
        return Com_Printf(CON_CHANNEL_SYSTEM, "Error Updating NVConfig: Hunk_Alloc failed\n" );
