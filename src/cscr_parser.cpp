...
char *CCDECL Scr_ReadFile_FastFile(const char *filename, const char *extFilename, const char *codePos, bool archive)
{
  RawFile *rawfile;
  int len;
...
char *CCDECL Scr_ReadFile_LoadObj(const char *filename, const char *extFilename, const char *codePos, bool archive)
{
  int len;
  int f;
  char *sourceBuf;
...
char *CCDECL Scr_ReadFile(const char *filename, const char *extFilename, const char *codePos, bool archive)
{
  int file;
...
char *CCDECL Scr_AddSourceBuffer( const char *filename, const char *extFilename, const char *codePos, bool archive)
{
  const char *source;
  char c;
...
void CCDECL Scr_GetTextSourcePos(const char *buf, const char *codePos, char *line)
{
  unsigned int bufferIndex;
  int col;
